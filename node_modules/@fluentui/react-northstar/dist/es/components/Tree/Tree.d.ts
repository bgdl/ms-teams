...
import { ShorthandRenderFunction, WithAsProp, ShorthandCollection, ShorthandValue, ComponentEventHandler } from '../../types';
...
declare class Tree extends AutoControlledComponent<WithAsProp<TreeProps>, TreeState> {
    ...
    static Item: {
        ...
        displayName: string;
        className: string;
        handledProps: ("expanded" | "title" | "children" | "id" | "className" | "variables" | "styles" | "accessibility" | "design" | "contentRef" | "index" | "onTitleClick" | "items" | "renderItemTitle" | "level" | "treeSize" | "onFocusFirstChild" | "onFocusParent" | "onSiblingsExpand" | "parent")[];
        create: ShorthandFactory<TreeItemProps>;
        slotClassNames: import("./TreeItem").TreeItemSlotClassNames;
    };
    static Title: {
        <Tag>(x: {
            as: Tag;
        ...
        displayName: string;
        className: string;
        handledProps: ("content" | "expanded" | "children" | "className" | "onClick" | "variables" | "styles" | "accessibility" | "design" | "index" | "hasSubtree" | "level" | "treeSize")[];
