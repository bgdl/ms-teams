...
import { AutoControlledComponent, RenderResultConfig, UIComponentProps, ChildrenComponentProps } from '../../utils';
import { SupportedIntrinsicInputProps } from '../../utils/htmlPropsUtils';
import { WithAsProp, ShorthandValue, ComponentEventHandler } from '../../types';
...
declare class Input extends AutoControlledComponent<WithAsProp<InputProps>, InputState> {
    ...
    static propTypes: {
        ...
        defaultValue: PropTypes.Requireable<import("csstype").AnimationIterationCountProperty>;
        disabled: PropTypes.Requireable<boolean>;
        fluid: PropTypes.Requireable<boolean>;
        icon: PropTypes.Requireable<PropTypes.ReactNodeLike>;
        iconPosition: PropTypes.Requireable<string>;
        input: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        inputRef: PropTypes.Requireable<{
            current: any;
        } | ((...args: any[]) => any)>;
        ...
        value: PropTypes.Requireable<import("csstype").AnimationIterationCountProperty>;
        wrapper: PropTypes.Requireable<PropTypes.ReactNodeLike>;
    ...
    actionHandlers: {
        clear: (e: React.KeyboardEvent<Element>) => void;
    };
    renderComponent({ accessibility, ElementType, unhandledProps, styles, variables }: RenderResultConfig<InputProps>): React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)>;
    handleIconOverrides: (predefinedProps: any) => {
        onClick: (e: React.SyntheticEvent<Element, Event>) => void;
    };
    handleChange: (e: React.ChangeEvent<HTMLInputElement>) => void;
    handleOnClear: (e: React.SyntheticEvent<Element, Event>) => void;
...
declare const _default: {
    ...
    (x: {
        ...
        type?: string;
        inputRef?: React.Ref<HTMLElement>;
        value?: import("csstype").AnimationIterationCountProperty;
        wrapper?: ShorthandValue<BoxProps>;
        className?: string;
        ...
        pattern?: string;
        list?: string;
        step?: import("csstype").AnimationIterationCountProperty;
        id?: string;
        checked?: boolean;
        ...
        autoComplete?: string;
        autoFocus?: boolean;
        max?: import("csstype").AnimationIterationCountProperty;
        maxLength?: number;
        min?: import("csstype").AnimationIterationCountProperty;
        minLength?: number;
        readOnly?: boolean;
        required?: boolean;
    ...
    getAutoControlledStateFromProps: typeof Input.getAutoControlledStateFromProps;
