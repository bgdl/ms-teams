...
declare const _default: {
    ...
    (x: {
        ...
        column?: boolean;
        wrap?: boolean;
        hAlign?: "stretch" | "center" | "end" | "start";
        vAlign?: "stretch" | "center" | "end" | "start";
        space?: "around" | "between" | "evenly";
        gap?: "gap.smaller" | "gap.small" | "gap.medium" | "gap.large";
        padding?: "padding.medium";
        debug?: boolean;
    ...
    displayName: string;
    className: string;
    handledProps: ("space" | "column" | "inline" | "wrap" | "fill" | "padding" | "gap" | "children" | "className" | "variables" | "styles" | "design" | "debug" | "hAlign" | "vAlign")[];
    Item: React.FC<import("./FlexItem").FlexItemProps> & {
        className: string;
