...
import { UIComponent, UIComponentProps, SizeValue, ShorthandFactory } from '../../utils';
 ...
 */
declare class Loader extends UIComponent<WithAsProp<LoaderProps>, LoaderState> {
    ...
    static propTypes: {
        ...
        indicator: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        inline: PropTypes.Requireable<boolean>;
        label: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        labelPosition: PropTypes.Requireable<string>;
        size: PropTypes.Requireable<"medium" | "large" | "small" | "larger" | "smaller" | "smallest" | "largest">;
        svg: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
...
declare const _default: {
    ...
    (x: {
        ...
        inline?: boolean;
        label?: ShorthandValue<TextProps>;
        labelPosition?: "end" | "start" | "above" | "below";
    ...
    contextType: any;
    displayName: string;
    getDerivedStateFromProps: typeof Loader.getDerivedStateFromProps;
    className: string;
    handledProps: string[];
