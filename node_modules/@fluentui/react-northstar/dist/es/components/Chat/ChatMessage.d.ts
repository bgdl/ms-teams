...
export declare type ChatMessageStylesProps = Pick<ChatMessageProps, 'attached' | 'badgePosition' | 'mine'> & {
    focused: boolean;
    hasBadge: boolean;
...
declare const _default: {
    ...
    (x: {
        ...
        actionMenu?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | (MenuProps & {
            popper?: import("../../utils/positioner").PositioningProps;
        } & import("../../types").ObjectOf<any> & {
            children?: string | number | boolean | {} | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | import("../../types").ShorthandRenderProp<MenuProps & {
                popper?: import("../../utils/positioner").PositioningProps;
            }>;
        }) | ShorthandCollection<MenuItemProps, never>;
        ...
        onMouseEnter?: ComponentEventHandler<ChatMessageProps>;
        positionActionMenu?: boolean;
        reactionGroup?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | ShorthandCollection<ReactionProps, never> | (ReactionGroupProps & import("../../types").ObjectOf<any> & {
            children?: string | number | boolean | {} | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | import("../../types").ShorthandRenderProp<ReactionGroupProps>;
        });
    ...
    create: import("../../utils").ShorthandFactory<ChatMessageProps>;
