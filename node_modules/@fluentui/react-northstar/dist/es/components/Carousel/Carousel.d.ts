...
import { UIComponentProps, ShorthandFactory, ChildrenComponentProps, AutoControlledComponent } from '../../utils';
import { WithAsProp, DebounceResultFn, ShorthandCollection, ShorthandValue, ComponentEventHandler } from '../../types';
import { CarouselItemProps } from './CarouselItem';
import { CarouselNavigationProps } from './CarouselNavigation';
import { CarouselNavigationItemProps } from './CarouselNavigationItem';
import { CarouselPaddleProps } from './CarouselPaddle';
...
declare class Carousel extends AutoControlledComponent<WithAsProp<CarouselProps>, CarouselState> {
    static create: ShorthandFactory<CarouselProps>;
    static displayName: string;
    static className: string;
    static slotClassNames: CarouselSlotClassNames;
    static propTypes: {
        activeIndex: PropTypes.Requireable<import("csstype").AnimationIterationCountProperty>;
        ariaRoleDescription: PropTypes.Requireable<string>;
        ariaLabel: PropTypes.Requireable<string>;
        circular: PropTypes.Requireable<boolean>;
        defaultActiveIndex: PropTypes.Requireable<import("csstype").AnimationIterationCountProperty>;
        getItemPositionText: PropTypes.Requireable<(...args: any[]) => any>;
        items: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        navigation: PropTypes.Requireable<unknown>;
        navigationPosition: PropTypes.Requireable<string>;
        onActiveIndexChange: PropTypes.Requireable<(...args: any[]) => any>;
        paddleNext: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        paddlesPosition: PropTypes.Requireable<string>;
        paddlePrevious: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
    ...
    static Item: {
        ...
        create: ShorthandFactory<CarouselItemProps>;
        _handledPropsCache: string[];
        slotClassNames: import("./CarouselItem").CarouselItemSlotClassNames;
    };
    static Navigation: {
        <Tag>(x: {
            as: Tag;
        ...
        handledProps: string[];
        unhandledProps: string[];
        create: ShorthandFactory<CarouselNavigationProps>;
        _handledPropsCache: string[];
    };
    static NavigationItem: {
        ...
        handledProps: string[];
        unhandledProps: string[];
        create: ShorthandFactory<CarouselNavigationItemProps>;
        _handledPropsCache: string[];
        slotClassNames: import("./CarouselNavigationItem").CarouselNavigationItemSlotClassNames;
    };
    static Paddle: {
        <Tag>(x: {
            as: Tag;
        ...
        create: ShorthandFactory<CarouselPaddleProps>;
        slotClassNames: import("./CarouselPaddle").CarouselPaddleSlotClassNames;
    };
    ...
    actionHandlers: {
        showNextSlideByKeyboardNavigation: (e: any) => void;
        showPreviousSlideByKeyboardNavigation: (e: any) => void;
        showNextSlideByPaddlePress: (e: any) => void;
        showPreviousSlideByPaddlePress: (e: any) => void;
    };
    getInitialAutoControlledState(): CarouselState;
    itemRefs: React.RefObject<HTMLElement>[];
    paddleNextRef: React.RefObject<HTMLElement>;
    paddlePreviousRef: React.RefObject<HTMLElement>;
    focusItemAtIndex: DebounceResultFn<(index: number) => void>;
    setActiveIndex(e: React.SyntheticEvent, index: number, focusItem: boolean): void;
    overrideItemProps: (predefinedProps: any) => {
        onFocus: (e: any, itemProps: any) => void;
        onBlur: (e: any, itemProps: any) => void;
    };
    renderContent: (accessibility: any, classes: any, unhandledProps: any) => JSX.Element;
    handleNextPaddleFocus: () => void;
    handlePreviousPaddleFocus: () => void;
    showPreviousSlide: (e: React.SyntheticEvent<Element, Event>, focusItem: boolean) => void;
    showNextSlide: (e: React.SyntheticEvent<Element, Event>, focusItem: boolean) => void;
    handlePaddleOverrides: (predefinedProps: CarouselPaddleProps, paddleName: string) => {
        onClick: (e: React.SyntheticEvent<Element, Event>, paddleProps: CarouselPaddleProps) => void;
        onBlur: (e: React.FocusEvent<Element>, paddleProps: CarouselPaddleProps) => void;
        onFocus: (e: React.SyntheticEvent<Element, Event>, paddleProps: CarouselPaddleProps) => void;
    };
    renderPaddles: (accessibility: any) => JSX.Element;
...
declare const _default: {
    ...
    (x: {
        ...
        navigation?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | ShorthandCollection<CarouselNavigationItemProps, never> | (CarouselNavigationProps & import("../../types").ObjectOf<any> & {
            children?: string | number | boolean | {} | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | import("../../types").ShorthandRenderProp<CarouselNavigationProps>;
        });
    ...
    getAutoControlledStateFromProps: typeof Carousel.getAutoControlledStateFromProps;
    unhandledProps: string[];
    create: ShorthandFactory<CarouselProps>;
    _handledPropsCache: string[];
