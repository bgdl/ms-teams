...
declare const _default: {
    ...
    (x: {
        ...
        header?: ShorthandValue<TextProps>;
        icon?: ShorthandValue<BoxProps>;
        progress?: import("csstype").AnimationIterationCountProperty;
        onClick?: ComponentEventHandler<AttachmentProps>;
        className?: string;
    ...
    displayName: string;
    className: string;
    handledProps: ("progress" | "icon" | "disabled" | "header" | "children" | "className" | "onClick" | "variables" | "styles" | "accessibility" | "design" | "action" | "actionable" | "description")[];
    create: import("../../utils").ShorthandFactory<AttachmentProps>;
