...
import { commonPropTypes, AutoControlledComponent, doesNodeContainClick, applyAccessibilityKeyHandlers, getOrGenerateIdFromShorthand } from '../../utils';
...
function (_AutoControlledCompon) {
  ...
  _createClass(Dialog, [{
    ...
    value: function renderComponent(_ref) {
      ...
      var cancelElement = Button.create(cancelButton, {
        overrideProps: this.handleCancelButtonOverrides
      });
      var confirmElement = Button.create(confirmButton, {
...
Dialog.slotClassNames = {
  ...
  footer: "".concat(Dialog.className, "__footer")
};
/**
