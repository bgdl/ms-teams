...
import { default as ToolbarMenuItem } from '../../../../components/Toolbar/ToolbarMenuItem';
...
var toolbarMenuItemStyles = {
  root: function root(_ref) {
    ...
    return Object.assign({
      ...
      }, _defineProperty(_hover, "& .".concat(ToolbarMenuItem.slotClassNames.submenuIndicator), {
        backgroundImage: submenuIndicatorUrl(v.menuItemForegroundHover || colors.menuItemForegroundHover)
      }), _defineProperty(_hover, "& .".concat(ToolbarMenuItem.slotClassNames.activeIndicator), {
    ...
    }, _defineProperty(_ref2, "& .".concat(ToolbarMenuItem.slotClassNames.submenuIndicator), {
      backgroundImage: submenuIndicatorUrl(v.menuItemForegroundDisabled || colors.foregroundDisabled1)
    }), _defineProperty(_ref2, "& .".concat(ToolbarMenuItem.slotClassNames.activeIndicator), {
      backgroundImage: activeIndicatorUrl(v.menuItemForegroundDisabled || colors.foregroundDisabled1)
    }), _defineProperty(_ref2, ':hover', {// empty to overwrite all existing hover styles
    }), _ref2));
  },
