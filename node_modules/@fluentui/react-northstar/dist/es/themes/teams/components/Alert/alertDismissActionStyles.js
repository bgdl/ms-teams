...
import AlertDismissAction from '../../../../components/Alert/AlertDismissAction';
...
var alertDismissActionStyles = {
  root: function root(_ref) {
    ...
    return Object.assign({
      ...
      outline: true
    }), {}, !p.hasContent && _defineProperty({}, "& .".concat(AlertDismissAction.slotClassNames.content), Object.assign({}, getIndicatorStyles(dismissActionIndicatorColor, true, v.dismissActionIndicatorSize))), {
      ':hover': Object.assign({
        backgroundColor: v.hoverBackgroundColor,
        color: 'currentColor'
      }, getIconFillOrOutlineStyles({
        outline: false
      }), {}, !p.hasContent && _defineProperty({}, "& .".concat(AlertDismissAction.slotClassNames.content), Object.assign({}, getIndicatorStyles(dismissActionIndicatorColor, false, v.dismissActionIndicatorSize))), {}, getBorderFocusStyles({
        variables: {
      ...
      ':focus-visible': Object.assign({
        ...
        outline: false
      }), {}, !p.hasContent && _defineProperty({}, "& .".concat(AlertDismissAction.slotClassNames.content), Object.assign({}, getIndicatorStyles(dismissActionIndicatorColor, false, v.dismissActionIndicatorSize))), {
        ':hover': {
