...
declare const createComponentInternal: <P extends ObjectOf<any> = any>({ displayName, className, shorthandPropName, defaultProps, handledProps, propTypes, actionHandlers, render, }: CreateComponentConfig<P>) => CreateComponentReturnType<P>;
