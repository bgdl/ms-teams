...
var getToggleButton = function (wrapper) {
    return utils_1.findIntrinsicElement(wrapper, "." + SplitButtonToggle_1.default.className);
};
var getMainButton = function (wrapper) {
    return utils_1.findIntrinsicElement(wrapper, "." + MenuButton_1.default.className + " ." + Button_1.default.className);
};
var getMenuItems = function (wrapper) {
    return utils_1.findIntrinsicElement(wrapper, "." + Menu_1.default.slotClassNames.item);
};
var getMenu = function (wrapper) { return utils_1.findIntrinsicElement(wrapper, "." + Menu_1.default.className); };
describe('SplitButton', function () {
    commonTests_1.isConformant(SplitButton_1.default, { autoControlledProps: ['open'] });
    implementsPopperProps_1.default(SplitButton_1.default, { requiredProps: { open: true } });
    describe('open', function () {
        test('is toggled between true and false on toggle button click', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(SplitButton_1.default, { menu: mockMenu, button: "test" }));
        ...
        test('is false when clicking menu item', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(SplitButton_1.default, { menu: mockMenu, button: "test", defaultOpen: true }));
    ...
    test('onMenuItemClick', function () {
        ...
        var wrapper = utils_1.mountWithProvider(React.createElement(SplitButton_1.default, { menu: mockMenu, button: "test", onMenuItemClick: onMenuItemClick, defaultOpen: true }));
        getMenuItems(wrapper)
            .at(0)
            .simulate('click');
    ...
    test('onMainButtonClick', function () {
        ...
        var wrapper = utils_1.mountWithProvider(React.createElement(SplitButton_1.default, { menu: mockMenu, button: "test", onMainButtonClick: onMainButtonClick }));
