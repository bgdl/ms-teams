...
var items = [
    {
        ...
        content: (React.createElement("div", null,
            React.createElement(Text_1.default, { content: 'item1' }),
            " ",
            React.createElement(Button_1.default, { id: buttonName, content: buttonName }))),
    },
    {
        key: 'item2',
        content: React.createElement(Text_1.default, { content: 'item2' }),
    },
    {
        key: 'item3',
        content: React.createElement(Text_1.default, { content: 'item3' }),
    },
    {
        key: 'item4',
        content: React.createElement(Text_1.default, { content: 'item4' }),
    },
];
function renderCarousel(props) {
    return utils_1.mountWithProvider(React.createElement(Carousel_1.default, tslib_1.__assign({ items: items, getItemPositionText: function (index, length) { return index + 1 + " of " + length; } }, props)));
}
var getItemsContainer = function (wrapper) {
    return utils_1.findIntrinsicElement(wrapper, "." + Carousel_1.default.slotClassNames.itemsContainer);
};
var getPaddleNextWrapper = function (wrapper) {
    return utils_1.findIntrinsicElement(wrapper, "." + Carousel_1.default.slotClassNames.paddleNext);
};
var getPaddlePreviousWrapper = function (wrapper) {
    return utils_1.findIntrinsicElement(wrapper, "." + Carousel_1.default.slotClassNames.paddlePrevious);
};
var getPaginationWrapper = function (wrapper) {
    return utils_1.findIntrinsicElement(wrapper, "." + Carousel_1.default.slotClassNames.pagination);
};
var getNavigationNavigationWrapper = function (wrapper) {
    return utils_1.findIntrinsicElement(wrapper, "." + CarouselNavigation_1.default.className);
};
var getNavigationNavigationItemAtIndexWrapper = function (wrapper, index) {
    return utils_1.findIntrinsicElement(wrapper, "." + CarouselNavigationItem_1.default.className).at(index);
};
var getItemAtIndexWrapper = function (wrapper, index) {
    return utils_1.findIntrinsicElement(wrapper, "." + CarouselItem_1.default.className).at(index);
};
var getButtonWrapper = function (wrapper) { return utils_1.findIntrinsicElement(wrapper, "#" + buttonName); };
jest.useFakeTimers();
describe('Carousel', function () {
    commonTests_1.isConformant(Carousel_1.default, { autoControlledProps: ['activeIndex'] });
    it('id for items is generated if not passed as prop', function () {
        var wrapper = renderCarousel();
        expect(getItemAtIndexWrapper(wrapper, 0)
            .getDOMNode()
            .getAttribute('id')).toMatch(/carousel-item-(\d)+/);
    });
    ...
    describe('paddle', function () {
        it('next should be hidden on last element if not circular', function () {
            ...
            expect(!wrapper.exists("." + Carousel_1.default.slotClassNames.paddleNext));
            expect(wrapper.exists("." + Carousel_1.default.slotClassNames.paddlePrevious));
        });
