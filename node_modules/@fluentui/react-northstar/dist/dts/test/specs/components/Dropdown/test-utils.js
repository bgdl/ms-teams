...
var renderDropdown = function (props) {
    ...
    var wrapper = utils_1.mountWithProvider(React.createElement(Dropdown_1.default, tslib_1.__assign({ items: items }, props)));
    var triggerButtonWrapper = utils_1.findIntrinsicElement(wrapper, "." + Dropdown_1.default.slotClassNames.triggerButton);
    var toggleIndicatorWrapper = utils_1.findIntrinsicElement(wrapper, "." + Dropdown_1.default.slotClassNames.toggleIndicator);
    var searchInputWrapper = utils_1.findIntrinsicElement(wrapper, "." + DropdownSearchInput_1.default.slotClassNames.input);
    var itemsListWrapper = utils_1.findIntrinsicElement(wrapper, "." + Dropdown_1.default.slotClassNames.itemsList);
    var getItemsWrapper = function () { return utils_1.findIntrinsicElement(wrapper, "." + Dropdown_1.default.slotClassNames.item); };
    var getSelectedItemsWrapper = function () { return utils_1.findIntrinsicElement(wrapper, "." + Dropdown_1.default.slotClassNames.selectedItem); };
    ...
    var getClearIndicatorWrapper = function () { return utils_1.findIntrinsicElement(wrapper, "." + Dropdown_1.default.slotClassNames.clearIndicator); };
    return {
        wrapper: wrapper,
