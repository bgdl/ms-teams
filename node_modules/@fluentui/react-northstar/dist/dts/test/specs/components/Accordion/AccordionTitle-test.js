...
describe('AccordionTitle', function () {
    commonTests_1.isConformant(AccordionTitle_1.default, {
        eventTargets: {
            onClick: "." + AccordionTitle_1.default.slotClassNames.contentWrapper,
        },
    });
    describe('accessiblity', function () {
        describe('header', function () {
            commonTests_1.handlesAccessibility(AccordionTitle_1.default, {
                requiredProps: { as: 'h3' },
    ...
    var getContent = function (wrapper) { return wrapper.find("div." + AccordionTitle_1.default.slotClassNames.contentWrapper); };
    describe('click handler', function () {
        it('is called on click', function () {
            var onClick = jest.fn();
            var wrapper = utils_1.mountWithProvider(React.createElement(AccordionTitle_1.default, { onClick: onClick }));
            getContent(wrapper).simulate('click');
            expect(onClick).toHaveBeenCalled();
        });
        it('is not called on click for disabled title', function () {
            var onClick = jest.fn();
            var wrapper = utils_1.mountWithProvider(React.createElement(AccordionTitle_1.default, { onClick: onClick, disabled: true }));
            getContent(wrapper).simulate('click');
