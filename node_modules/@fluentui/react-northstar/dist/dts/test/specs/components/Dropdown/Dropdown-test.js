...
describe('Dropdown', function () {
    commonTests_1.isConformant(Dropdown_1.default, {
        hasAccessibilityProp: false,
        autoControlledProps: ['highlightedIndex', 'open', 'searchQuery', 'activeSelectedIndex', 'value'],
    });
    commonTests_1.implementsShorthandProp(Dropdown_1.default)('list', List_1.default, {
        implementsPopper: true,
        requiredProps: { open: true },
    });
    describe('clearable', function () {
        it('value is cleared at Icon click', function () {
            var _a = test_utils_1.renderDropdown({
                clearable: true,
                defaultValue: test_utils_1.items[0],
        ...
        it('calls onChange on Icon click with an `empty` value', function () {
            ...
            var clickOnClearIndicator = test_utils_1.renderDropdown({
                onChange: onChange,
                defaultValue: test_utils_1.items[0],
                clearable: true,
            }).clickOnClearIndicator;
    ...
    describe('open', function () {
        it('it takes the value of the controlled prop', function () {
            var _a = test_utils_1.renderDropdown({ open: true }), getItemNodes = _a.getItemNodes, clickOnItemAtIndex = _a.clickOnItemAtIndex;
            expect(getItemNodes()).toHaveLength(test_utils_1.items.length);
            clickOnItemAtIndex(0);
            expect(getItemNodes()).toHaveLength(test_utils_1.items.length);
        });
        it('it takes the value of the default prop but can be changed', function () {
            var _a = test_utils_1.renderDropdown({ defaultOpen: true }), getItemNodes = _a.getItemNodes, clickOnItemAtIndex = _a.clickOnItemAtIndex;
            expect(getItemNodes()).toHaveLength(test_utils_1.items.length);
            clickOnItemAtIndex(0);
            expect(getItemNodes()).toHaveLength(0);
        });
        it('is "true" when opened by trigger button click', function () {
            var _a = test_utils_1.renderDropdown(), getItemNodes = _a.getItemNodes, clickOnTriggerButton = _a.clickOnTriggerButton;
        ...
        it('calls onOpenChange with a value that represents the open state', function () {
            ...
            var clickOnTriggerButton = test_utils_1.renderDropdown({
        ...
        it('is "true" when opened by toggle indicator click', function () {
            var _a = test_utils_1.renderDropdown(), clickOnToggleIndicator = _a.clickOnToggleIndicator, getItemNodes = _a.getItemNodes;
        ...
        it('is "false" when closed by hitting Escape in items list', function () {
            var _a = test_utils_1.renderDropdown({ defaultOpen: true }), keyDownOnItemsList = _a.keyDownOnItemsList, getItemNodes = _a.getItemNodes;
            expect(test_utils_1.items).toHaveLength(test_utils_1.items.length);
            keyDownOnItemsList('Escape');
            expect(getItemNodes()).toHaveLength(0);
        });
        it('is "false" when an item has been selected', function () {
            var _a = test_utils_1.renderDropdown({ defaultOpen: true }), clickOnItemAtIndex = _a.clickOnItemAtIndex, getItemNodes = _a.getItemNodes;
            clickOnItemAtIndex(0);
            expect(getItemNodes()).toHaveLength(0);
        });
        it('when set to "true" by trigger button click will move focus to the items list', function () {
            var _a = test_utils_1.renderDropdown(), clickOnTriggerButton = _a.clickOnTriggerButton, itemsListNode = _a.itemsListNode;
            clickOnTriggerButton();
            expect(itemsListNode).toHaveFocus();
        });
        it('is "false" when blurred by Tab on items list', function () {
            var _a = test_utils_1.renderDropdown({ defaultOpen: true }), getItemNodes = _a.getItemNodes, keyDownOnItemsList = _a.keyDownOnItemsList;
        ...
        it('is "true" when opened by space bar on trigger button', function () {
            var _a = test_utils_1.renderDropdown({}), getItemNodes = _a.getItemNodes, keyDownOnTriggerButton = _a.keyDownOnTriggerButton;
    ...
    describe('highlightedIndex', function () {
        ...
        it('is null when opened by toggle indicator click', function () {
            var _a = test_utils_1.renderDropdown(), clickOnToggleIndicator = _a.clickOnToggleIndicator, itemsListNode = _a.itemsListNode;
            clickOnToggleIndicator();
            expect(itemsListNode).not.toHaveAttribute('aria-activedescendant');
        });
        it('is first item index when opened by arrow down key', function () {
            var _a = test_utils_1.renderDropdown(), keyDownOnTriggerButton = _a.keyDownOnTriggerButton, itemsListNode = _a.itemsListNode;
            keyDownOnTriggerButton('ArrowDown');
            expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(0)));
        });
        it('is last item index when opened by arrow up key', function () {
            var _a = test_utils_1.renderDropdown(), keyDownOnTriggerButton = _a.keyDownOnTriggerButton, itemsListNode = _a.itemsListNode;
            keyDownOnTriggerButton('ArrowUp');
            expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(test_utils_1.items.length - 1)));
        });
        it('has the provided prop value when opened by click', function () {
            ...
            clickOnTriggerButton();
            expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(highlightedIndex)));
        });
        ...
        it('is defaultHighlightedIndex prop value at first opening, then null', function () {
            ...
            clickOnTriggerButton();
            expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(defaultHighlightedIndex)));
            clickOnTriggerButton();
            clickOnTriggerButton();
            expect(itemsListNode).not.toHaveAttribute('aria-activedescendant');
        });
        ...
        it('is set to 0 on searchQuery change and when highlightFirstItemOnOpen prop is provided', function () {
            ...
            changeSearchInput('i');
            expect(searchInputNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(0)));
            keyDownOnSearchInput('ArrowDown');
            expect(searchInputNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(1)));
        ...
        it('is the index of the value previously selected when opened', function () {
            var highlightedIndex = 2;
            var _a = test_utils_1.renderDropdown({
                value: test_utils_1.items[highlightedIndex],
            }), clickOnTriggerButton = _a.clickOnTriggerButton, itemsListNode = _a.itemsListNode;
            clickOnTriggerButton();
            expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(highlightedIndex)));
        });
        it('is the index of the (value previously selected + 1) when opened by arrow down', function () {
            ...
            keyDownOnTriggerButton('ArrowDown');
            expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(highlightedIndex + 1)));
        });
        ...
        it('is changed correctly on arrow down navigation', function () {
            var _a = test_utils_1.renderDropdown({ defaultOpen: true }), keyDownOnItemsList = _a.keyDownOnItemsList, itemsListNode = _a.itemsListNode;
            for (var index = 0; index < test_utils_1.items.length; index++) {
                keyDownOnItemsList('ArrowDown');
                expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(index)));
            }
        });
        it('is changed correctly on arrow up navigation', function () {
            var _a = test_utils_1.renderDropdown({ defaultOpen: true }), keyDownOnItemsList = _a.keyDownOnItemsList, itemsListNode = _a.itemsListNode;
            for (var index = test_utils_1.items.length - 1; index >= 0; index--) {
                keyDownOnItemsList('ArrowUp');
                expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(index)));
            }
        });
        it('is changed correctly on arrow down and shift navigation', function () {
            var _a = test_utils_1.renderDropdown({ defaultOpen: true }), keyDownOnTriggerButton = _a.keyDownOnTriggerButton, itemsListNode = _a.itemsListNode;
            keyDownOnTriggerButton('ArrowDown', { shiftKey: true });
            expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(4)));
        });
        it('is changed correctly on arrow up and shift navigation', function () {
            var _a = test_utils_1.renderDropdown({
                defaultHighlightedIndex: test_utils_1.items.length - 1,
                defaultOpen: true,
            }), keyDownOnTriggerButton = _a.keyDownOnTriggerButton, itemsListNode = _a.itemsListNode;
        ...
        it('is updated correctly when hovering over items', function () {
            ...
            expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(1)));
            mouseOverItemAtIndex(3);
            expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(3)));
        });
        it('is updated correctly when hovering over items and using arrow keys to navigate', function () {
            ...
            mouseOverItemAtIndex(1);
            keyDownOnItemsList('ArrowDown');
            expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(2)));
        ...
        it('jumps to the item starting with the keys tapped in rapid succession', function () {
            ...
            keyDownOnItemsList('A');
            expect(itemsListNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_1.getItemIdRegexByIndex(0)));
            jest.advanceTimersByTime(Dropdown_1.default.charKeyPressedCleanupTime / 2);
    ...
    describe('value', function () {
        it('it takes the value of the controlled prop', function () {
            var value = test_utils_1.items[2];
            var _a = test_utils_1.renderDropdown({ value: value, defaultOpen: true }), triggerButtonNode = _a.triggerButtonNode, clickOnItemAtIndex = _a.clickOnItemAtIndex;
            expect(triggerButtonNode).toHaveTextContent(value);
            clickOnItemAtIndex(0);
            expect(triggerButtonNode).toHaveTextContent(value);
        });
        it('it takes the value of the default prop but can be changed', function () {
            var defaultValue = test_utils_1.items[2];
            ...
            expect(triggerButtonNode).toHaveTextContent(test_utils_1.items[itemToBeClickedIndex]);
        });
        it('has onChange called when item is added', function () {
            var itemToClickIndex = 2;
            var onChange = jest.fn();
            var clickOnItemAtIndex = test_utils_1.renderDropdown({ open: true, onChange: onChange }).clickOnItemAtIndex;
            clickOnItemAtIndex(itemToClickIndex);
            expect(onChange).toHaveBeenCalledTimes(1);
            expect(onChange).toHaveBeenCalledWith(null, expect.objectContaining({
                value: test_utils_1.items[itemToClickIndex],
                searchQuery: test_utils_1.items[itemToClickIndex],
            }));
        });
        it('has onChange called when item is added or removed on multiple', function () {
            ...
            var _a = test_utils_1.renderDropdown({
                open: true,
                defaultValue: [test_utils_1.items[defaultSelectedItemIndex]],
                onChange: onChange,
                multiple: true,
            ...
            expect(onChange).toHaveBeenCalledTimes(1);
            expect(onChange).toHaveBeenCalledWith(null, expect.objectContaining({
                value: [test_utils_1.items[defaultSelectedItemIndex], test_utils_1.items[itemToClickIndex]],
            }));
        ...
        it('has onChange called with null value by hitting Escape in search input', function () {
            var onChange = jest.fn();
            var keyDownOnSearchInput = test_utils_1.renderDropdown({
                search: true,
                onChange: onChange,
                defaultValue: test_utils_1.items[2],
                defaultSearchQuery: test_utils_1.items[2],
        ...
        it('is set by clicking on item', function () {
            var itemSelectedIndex = 2;
            var _a = test_utils_1.renderDropdown({ defaultOpen: true }), triggerButtonNode = _a.triggerButtonNode, clickOnItemAtIndex = _a.clickOnItemAtIndex;
            clickOnItemAtIndex(itemSelectedIndex);
            expect(triggerButtonNode).toHaveTextContent(test_utils_1.items[itemSelectedIndex]);
        });
        ...
        it('is set correctly in multiple selection by using Tab on highlighted item', function () {
            ...
            var _a = test_utils_1.renderDropdown({
                defaultOpen: true,
                defaultHighlightedIndex: itemSelectedIndex,
                defaultValue: test_utils_1.items[4],
                multiple: true,
            ...
            expect(getSelectedItemNodeAtIndex(1)).toHaveTextContent(test_utils_1.items[3]);
            expect(getSelectedItemNodeAtIndex(0)).toHaveTextContent(test_utils_1.items[4]);
        });
        it('is set correctly in multiple selection by using Shift+Tab on highlighted item', function () {
            ...
            expect(triggerButtonNode).toHaveTextContent('');
            expect(getSelectedItemNodes()).toHaveLength(2);
            expect(getSelectedItemNodeAtIndex(1)).toHaveTextContent(test_utils_1.items[2]);
            expect(getSelectedItemNodeAtIndex(0)).toHaveTextContent(test_utils_1.items[4]);
        });
        it('is not cleared when hitting Escape if not search', function () {
            var defaultValue = test_utils_1.items[0];
            var _a = test_utils_1.renderDropdown({
                defaultValue: defaultValue,
        ...
        it('is not cleared when hitting Escape if search but multiple', function () {
            var defaultValue = [test_utils_1.items[0], test_utils_1.items[1]];
            var _a = test_utils_1.renderDropdown({
                defaultValue: defaultValue,
                search: true,
                multiple: true,
        ...
        it('has an array of items if more items are selected and the multiple prop is supplied', function () {
            var _a = test_utils_1.renderDropdown({
                multiple: true,
                defaultValue: [test_utils_1.items[0], test_utils_1.items[1]],
            }), getSelectedItemNodes = _a.getSelectedItemNodes, getSelectedItemNodeAtIndex = _a.getSelectedItemNodeAtIndex;
            expect(getSelectedItemNodes()).toHaveLength(2);
            expect(getSelectedItemNodeAtIndex(0)).toHaveTextContent(test_utils_1.items[0]);
            expect(getSelectedItemNodeAtIndex(1)).toHaveTextContent(test_utils_1.items[1]);
        });
        ...
        it('has the item removed if it receives delete key down', function () {
            ...
            keyDownOnSelectedItemAtIndex(0, 'Delete');
            expect(getSelectedItemNodes()).toHaveLength(1);
            expect(getSelectedItemNodeAtIndex(0)).toHaveTextContent(test_utils_1.items[1]);
        });
        it('has the item removed if it receives click on remove icon', function () {
            ...
            utils_1.findIntrinsicElement(wrapper, "." + DropdownSelectedItem_1.default.slotClassNames.icon)
                .at(0)
                .simulate('click');
            expect(getSelectedItemNodes()).toHaveLength(1);
            expect(getSelectedItemNodeAtIndex(0)).toHaveTextContent(test_utils_1.items[1]);
    ...
    describe('getA11ySelectionMessage', function () {
        ...
        it('creates message container element', function () {
            var getA11yMessageContainerNode = test_utils_1.renderDropdown({ getA11ySelectionMessage: {} }).getA11yMessageContainerNode;
        ...
        it('has the onAdd message inserted and cleared after an item has been added to selection', function () {
            ...
            clickOnItemAtIndex(itemToBeClickedIndex);
            expect(getA11yMessageContainerNode()).toHaveTextContent(test_utils_1.items[itemToBeClickedIndex] + " has been added");
            jest.runAllTimers();
        ...
        it('has the onRemove message inserted and cleared after an item has been removed from selection', function () {
            ...
            var _a = test_utils_1.renderDropdown({
                defaultOpen: true,
                multiple: true,
                defaultValue: [test_utils_1.items[itemSelectedByDefaultIndex]],
            ...
            keyDownOnSelectedItemAtIndex(0, 'Delete');
            expect(getA11yMessageContainerNode()).toHaveTextContent(test_utils_1.items[itemSelectedByDefaultIndex] + " has been removed");
            jest.runAllTimers();
            expect(getA11yMessageContainerNode()).toHaveTextContent('');
        });
    });
    describe('searchQuery', function () {
        it('it takes the value of the controlled prop', function () {
            ...
            var _a = test_utils_1.renderDropdown({ searchQuery: searchQuery, search: true }), changeSearchInput = _a.changeSearchInput, searchInputNode = _a.searchInputNode;
        ...
        it('has onSearchQueryChange called each time the input is changed', function () {
            ...
            var changeSearchInput = test_utils_1.renderDropdown({ search: true, onSearchQueryChange: onSearchQueryChange }).changeSearchInput;
        ...
        it('has onSearchQueryChange called with empty string by hitting Escape in search input', function () {
            var onSearchQueryChange = jest.fn();
            var keyDownOnSearchInput = test_utils_1.renderDropdown({ search: true, onSearchQueryChange: onSearchQueryChange, defaultSearchQuery: 'foo' }).keyDownOnSearchInput;
            keyDownOnSearchInput('Escape');
            expect(onSearchQueryChange).toHaveBeenCalledTimes(1);
            expect(onSearchQueryChange).toHaveBeenLastCalledWith(null, expect.objectContaining({
                searchQuery: '',
        ...
        it('has onChange called with null when changed to empty string and there was item selected', function () {
            ...
            var _a = test_utils_1.renderDropdown({
                ...
                clearable: true,
                onChange: onChange,
                defaultSearchQuery: test_utils_1.items[0],
        ...
        it('is the string equivalent of selected item in single search', function () {
            var itemSelectedIndex = 2;
            var itemsAsObjects = test_utils_1.items.map(function (item) { return ({ value: item, key: item }); });
            var _a = test_utils_1.renderDropdown({
                search: true,
                defaultOpen: true,
    ...
    describe('activeSelectedIndex', function () {
        ...
        it('is set as last index on left arrow from the search query', function () {
            var _a = test_utils_1.renderDropdown({
                multiple: true,
                value: [test_utils_1.items[0], test_utils_1.items[1], test_utils_1.items[2]],
                search: true,
    ...
    describe('focused', function () {
        it('is "true" when focus is on trigger button', function () {
            var _a = test_utils_1.renderDropdown(), wrapper = _a.wrapper, focusTriggerButton = _a.focusTriggerButton;
            focusTriggerButton();
            expect(wrapper.find(Dropdown_1.default).state('focused')).toBe(true);
        });
        it('is "true" when focus is on search input', function () {
            var _a = test_utils_1.renderDropdown({ search: true }), wrapper = _a.wrapper, focusSearchInput = _a.focusSearchInput;
            focusSearchInput();
            expect(wrapper.find(Dropdown_1.default).state('focused')).toBe(true);
        });
        it('is "true" when focus is on the list', function () {
            var _a = test_utils_1.renderDropdown({ open: true }), wrapper = _a.wrapper, focusItemsList = _a.focusItemsList;
            focusItemsList();
            expect(wrapper.find(Dropdown_1.default).state('focused')).toBe(true);
        });
    });
    describe('toggleIndicatorNode', function () {
        ...
        it('moves focus to input in search mode', function () {
            var _a = test_utils_1.renderDropdown({ search: true }), clickOnToggleIndicator = _a.clickOnToggleIndicator, searchInputNode = _a.searchInputNode;
            clickOnToggleIndicator();
            expect(searchInputNode).toHaveFocus();
        });
    });
    describe('moveFocusOnTab', function () {
        ...
        it('keeps focus on trigger button when not passed', function () {
            var keyDownOnItemsList = test_utils_1.renderDropdown({
                defaultOpen: true,
                defaultHighlightedIndex: 0,
                multiple: true,
            }).keyDownOnItemsList;
    ...
    describe('multiple', function () {
        it('can be switched to "multiple"', function () {
            var _a = test_utils_1.renderDropdown({ value: test_utils_1.items[0] }), wrapper = _a.wrapper, getSelectedItemNodes = _a.getSelectedItemNodes;
        ...
        it('does not contain duplicates after an item is selected', function () {
            ...
            clickOnItemAtIndex(0);
            expect(getSelectedItemNodes()).toHaveLength(1);
            expect(getItemNodes()).toHaveLength(test_utils_1.items.length - 1);
            clickOnItemAtIndex(0);
            expect(getSelectedItemNodes()).toHaveLength(2);
            expect(getItemNodes()).toHaveLength(test_utils_1.items.length - 2);
        });
        it('does not contain duplicates when value is set', function () {
            var _a = test_utils_1.renderDropdown({
                multiple: true,
                open: true,
                value: test_utils_1.items[0],
    ...
    describe('items', function () {
        it('have onClick called when passed stop event from being propagated', function () {
            ...
            var clickOnItemAtIndex = test_utils_1.renderDropdown({ items: items, defaultOpen: true }).clickOnItemAtIndex;
        ...
        it('when selected have onClick called when passed stop event from being propagated', function () {
            ...
            var mockedEvent = { stopPropagation: stopPropagation };
            var items = [{ header: 'Venom', onClick: onClick }];
            var clickOnSelectedItemAtIndex = test_utils_1.renderDropdown({
                items: items,
                multiple: true,
                value: items,
                defaultOpen: true,
    ...
    describe('renderSelectedItem', function () {
        it('is called in multiple selection', function () {
            ...
            var value = [test_utils_1.items[0], test_utils_1.items[1]];
            test_utils_1.renderDropdown({ renderSelectedItem: renderSelectedItem, multiple: true, value: value });
    ...
    describe('footer and header messages', function () {
        it('shows loadingMessage when status is loading', function () {
            ...
            var getItemNodeAtIndex = test_utils_1.renderDropdown({
                open: true,
                loadingMessage: loadingMessage,
                loading: true,
            }).getItemNodeAtIndex;
            expect(getItemNodeAtIndex(test_utils_1.items.length)).toHaveTextContent(loadingMessage);
        });
        ...
        it('can juggle between messages depending on the status', function () {
            ...
            expect(getItemNodes()).toHaveLength(test_utils_1.items.length + 2);
            expect(getItemNodeAtIndex(0)).toHaveTextContent(headerMessage);
            expect(getItemNodeAtIndex(test_utils_1.items.length + 1)).toHaveTextContent(loadingMessage);
            rerender({ items: [] });
            expect(getItemNodes()).toHaveLength(2);
            expect(getItemNodeAtIndex(0)).toHaveTextContent(headerMessage);
            ...
            rerender({ items: [test_utils_1.items[0]] });
            expect(getItemNodes()).toHaveLength(2);
            expect(getItemNodeAtIndex(0)).toHaveTextContent(headerMessage);
            expect(getItemNodeAtIndex(1)).toHaveTextContent(test_utils_1.items[0]);
            rerender({ headerMessage: undefined });
            expect(getItemNodes()).toHaveLength(1);
            expect(getItemNodeAtIndex(0)).toHaveTextContent(test_utils_1.items[0]);
        });
    });
});
