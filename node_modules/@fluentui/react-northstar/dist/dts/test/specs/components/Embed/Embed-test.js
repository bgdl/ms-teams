...
describe('Embed', function () {
    commonTests_1.isConformant(Embed_1.default, { autoControlledProps: ['active'] });
    describe('accessibility', function () {
        commonTests_1.handlesAccessibility(Embed_1.default, { defaultRootRole: 'presentation' });
    });
    describe('onClick', function () {
        test('is called with (e, props) on a click', function () {
            var onClick = jest.fn();
            var embed = utils_1.mountWithProviderAndGetComponent(Embed_1.default, React.createElement(Embed_1.default, { onClick: onClick }));
    ...
    describe('onActiveChange', function () {
        test('is called with (e, props) on a click', function () {
            ...
            var embed = utils_1.mountWithProviderAndGetComponent(Embed_1.default, React.createElement(Embed_1.default, { onActiveChange: onActiveChange }));
            embed.simulate('click');
