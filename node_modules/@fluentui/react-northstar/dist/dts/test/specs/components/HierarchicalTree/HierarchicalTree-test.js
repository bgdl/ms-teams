...
var getTitles = function (wrapper) {
    return wrapper.find("." + HierarchicalTreeTitle_1.default.className).filterWhere(function (n) { return typeof n.type() === 'string'; });
};
var getItems = function (wrapper) {
    return wrapper.find("." + HierarchicalTreeItem_1.default.className).filterWhere(function (n) { return typeof n.type() === 'string'; });
};
...
describe('HierarchialTree', function () {
    commonTests_1.isConformant(HierarchicalTree_1.default, {
        autoControlledProps: ['activeIndex'],
    });
    describe('activeIndex', function () {
        it('should contain index of item open at click', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(HierarchicalTree_1.default, { items: items }));
            getTitles(wrapper)
                .at(0) // title 1
                .simulate('click');
        ...
        it('should have index of item removed when closed at click', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(HierarchicalTree_1.default, { items: items, defaultActiveIndex: [0, 1] }));
            getTitles(wrapper)
                .at(0) // title 1
                .simulate('click');
        ...
        it('should contain only one index at a time if exclusive', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(HierarchicalTree_1.default, { items: items, exclusive: true }));
            getTitles(wrapper)
                .at(0) // title 1
                .simulate('click');
            checkOpenTitles(wrapper, ['1', '11', '12', '2', '3']);
        ...
        it('should expand subtrees only on current level on asterisk key', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(HierarchicalTree_1.default, { items: items, defaultActiveIndex: [0] }));
            getTitles(wrapper)
                .at(1) // title 11
                .simulate('keydown', { keyCode: keyboardKey['*'] });
        ...
        it('should not be changed on asterisk key if all siblings are already expanded', function () {
            var wrapper = utils_1.mountWithProvider(React.createElement(HierarchicalTree_1.default, { items: items, defaultActiveIndex: [0, 1, 2] }));
            getTitles(wrapper)
                .at(0) // title 1
                .simulate('keydown', { keyCode: keyboardKey['*'] });
            checkOpenTitles(wrapper, ['1', '11', '12', '2', '21', '22', '3']);
