    ...
    MenuItem.prototype.renderComponent = function (_a) {
        ...
        if (wrapper) {
            return Box_1.default.create(wrapper, {
                defaultProps: function () { return (tslib_1.__assign(tslib_1.__assign({ className: classnames_1.default(MenuItem.slotClassNames.wrapper, classes.wrapper) }, accessibility.attributes.wrapper), utils_1.applyAccessibilityKeyHandlers(accessibility.keyHandlers.wrapper, wrapper))); },
