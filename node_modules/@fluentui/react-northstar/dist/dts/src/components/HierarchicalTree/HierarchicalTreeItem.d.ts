...
declare const _default: {
    ...
    (x: {
        ...
        exclusive?: boolean;
        index?: number;
        items?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | ShorthandCollection<HierarchicalTreeItemProps, never> | (HierarchicalTreeProps & import("../../types").ObjectOf<any> & {
            children?: string | number | boolean | {} | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | import("../../types").ShorthandRenderProp<HierarchicalTreeProps>;
        });
        onTitleClick?: ComponentEventHandler<HierarchicalTreeItemProps>;
        open?: boolean;
        renderItemTitle?: ShorthandRenderFunction<HierarchicalTreeTitleProps>;
