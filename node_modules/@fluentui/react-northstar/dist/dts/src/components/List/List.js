...
var List = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(List.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var classes = react_bindings_1.useStyles(List.displayName, {
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(List.handledProps, props);
    ...
    var renderItems = function () { return _.map(items, function (item, index) { return ListItem_1.default.create(item, { defaultProps: function () { return ({ index: index }); } }); }); };
...
List.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    content: false,
...
List.create = utils_1.createShorthandFactory({ Component: List, mappedArrayProp: 'items' });
/**
 ...
 */
exports.default = types_1.withSafeTypeForAs(List);
