...
var ListItem = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(ListItem.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var _j = react_bindings_1.useStyles(ListItem.displayName, {
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(ListItem.handledProps, props);
    ...
    var element = (React.createElement(ElementType, tslib_1.__assign({}, getA11Props('root', tslib_1.__assign({ className: classes.root, onClick: handleClick }, unhandledProps))),
        mediaElement,
        React.createElement("div", { className: classnames_1.default(ListItem.slotClassNames.main, classes.main) },
            (headerElement || headerMediaElement) && (React.createElement("div", { className: classnames_1.default(ListItem.slotClassNames.headerWrapper, classes.headerWrapper) },
                headerElement,
                headerMediaElement)),
            (contentElement || contentMediaElement) && (React.createElement("div", { className: classnames_1.default(ListItem.slotClassNames.contentWrapper, classes.contentWrapper) },
                contentElement,
                contentMediaElement))),
        endMediaElement));
    setEnd();
...
ListItem.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    content: false,
...
ListItem.create = utils_1.createShorthandFactory({ Component: ListItem, mappedProp: 'content' });
/**
 * A ListItem contains a single piece of content within a List.
 */
exports.default = types_1.withSafeTypeForAs(ListItem);
