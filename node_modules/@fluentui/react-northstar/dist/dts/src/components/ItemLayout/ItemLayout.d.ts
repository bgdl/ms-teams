...
import { UIComponentProps, ContentComponentProps, ShorthandFactory } from '../../utils';
...
declare const _default: {
    ...
    (x: {
        ...
        headerMedia?: any;
        media?: any;
        renderContentArea?: (props: ItemLayoutProps, state: any, classes: Record<string, string>) => React.ReactNode;
        renderHeaderArea?: (props: ItemLayoutProps, state: any, classes: Record<string, string>) => React.ReactNode;
        renderMainArea?: (props: ItemLayoutProps, state: any, classes: Record<string, string>) => React.ReactNode;
        rootCSS?: React.CSSProperties;
        mediaCSS?: React.CSSProperties;
        headerCSS?: React.CSSProperties;
        headerMediaCSS?: React.CSSProperties;
