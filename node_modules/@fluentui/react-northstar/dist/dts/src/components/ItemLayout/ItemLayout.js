...
var ItemLayout = /** @class */ (function (_super) {
    ...
    ItemLayout.prototype.renderComponent = function (_a) {
        ...
        var mergedMediaClasses = classnames_1.default(ItemLayout.slotClassNames.media, classes.media);
        var mergedEndMediaClasses = classnames_1.default(ItemLayout.slotClassNames.endMedia, classes.endMedia);
    ...
    ItemLayout.className = 'ui-itemlayout';
    ...
    ItemLayout.defaultProps = {
        ...
        renderMainArea: function (props, state, classes) {
            ...
            return (React.createElement("div", { className: ItemLayout.slotClassNames.main, style: {
        ...
        renderHeaderArea: function (props, state, classes) {
            ...
            var mergedClasses = classnames_1.default(ItemLayout.slotClassNames.header, classes.header);
            var mediaClasses = classnames_1.default(ItemLayout.slotClassNames.headerMedia, classes.headerMedia);
        ...
        renderContentArea: function (props, state, classes) {
            ...
            var mergedClasses = classnames_1.default(ItemLayout.slotClassNames.content, classes.content);
            var mediaClasses = classnames_1.default(ItemLayout.slotClassNames.contentMedia, classes.contentMedia);
