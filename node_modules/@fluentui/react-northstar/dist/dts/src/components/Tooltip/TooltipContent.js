...
var TooltipContent = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(TooltipContent.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var classes = react_bindings_1.useStyles(TooltipContent.displayName, {
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(TooltipContent.handledProps, props);
...
TooltipContent.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon()), { placement: PropTypes.oneOf([
        'auto-start',
        'auto',
        'auto-end',
        'top-start',
...
TooltipContent.create = utils_1.createShorthandFactory({ Component: TooltipContent, mappedProp: 'content' });
/**
 * A TooltipContent contains the content of a Tooltip component.
 */
exports.default = types_1.withSafeTypeForAs(TooltipContent);
