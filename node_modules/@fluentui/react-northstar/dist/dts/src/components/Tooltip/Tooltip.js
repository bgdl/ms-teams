...
var Tooltip = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(Tooltip.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    var accessibility = props.accessibility, align = props.align, children = props.children, content = props.content, flipBoundary = props.flipBoundary, mountNode = props.mountNode, mouseLeaveDelay = props.mouseLeaveDelay, offset = props.offset, overflowBoundary = props.overflowBoundary, pointing = props.pointing, position = props.position, positionFixed = props.positionFixed, target = props.target, trigger = props.trigger, unstable_pinned = props.unstable_pinned;
    ...
    var renderPopperChildren = function (popperProps) {
        var tooltipContent = TooltipContent_1.default.create(content, {
    ...
    var element = (React.createElement(React.Fragment, null,
        ...
        React.createElement(PortalInner_1.default, { mountNode: mountNode },
            React.createElement(positioner_1.Popper, { align: align, flipBoundary: flipBoundary, offset: offset, overflowBoundary: overflowBoundary, pointerTargetRef: pointerTargetRef, position: position, positionFixed: positionFixed, enabled: open, rtl: context.rtl, targetRef: target || triggerRef, children: renderPopperChildren, unstable_pinned: unstable_pinned }))));
    setEnd();
    return element;
};
...
Tooltip.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    as: false,
    content: false,
})), { align: PropTypes.oneOf(positioner_1.ALIGNMENTS), children: PropTypes.element, defaultOpen: PropTypes.bool, mountNode: customPropTypes.domNode, mouseLeaveDelay: PropTypes.number, offset: PropTypes.string, open: PropTypes.bool, onOpenChange: PropTypes.func, pointing: PropTypes.bool, position: PropTypes.oneOf(positioner_1.POSITIONS), positionFixed: PropTypes.bool, target: customPropTypes.domNode, trigger: customPropTypes.every([customPropTypes.disallow(['children']), PropTypes.element]), content: customPropTypes.shorthandAllowingChildren, unstable_pinned: PropTypes.bool, flipBoundary: PropTypes.oneOfType([
        PropTypes.object,
...
Tooltip.Content = TooltipContent_1.default;
Tooltip.create = utils_1.createShorthandFactory({ Component: Tooltip, mappedProp: 'content' });
