...
import { AlertDismissActionProps } from './AlertDismissAction';
...
declare const _default: {
    ...
    (x: {
        ...
        actions?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | ShorthandCollection<ButtonProps, never> | (ButtonGroupProps & import("../../types").ObjectOf<any> & {
            children?: string | number | boolean | {} | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | import("../../types").ShorthandRenderProp<ButtonGroupProps>;
        });
        icon?: ShorthandValue<BoxProps>;
        header?: ShorthandValue<TextProps>;
    ...
    DismissAction: {
        ...
        displayName: string;
        className: string;
        handledProps: ("content" | "disabled" | "children" | "className" | "onClick" | "variables" | "styles" | "accessibility" | "design" | "success" | "danger" | "warning" | "info")[];
        create: import("../../utils").ShorthandFactory<AlertDismissActionProps>;
        slotClassNames: import("./AlertDismissAction").AlertDismissActionSlotClassNames;
    };
};
/**
