...
var AlertDismissAction = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(AlertDismissAction.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var _b = react_bindings_1.useStyles(AlertDismissAction.displayName, {
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(AlertDismissAction.handledProps, props);
...
AlertDismissAction.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    content: 'shorthand',
...
AlertDismissAction.create = utils_1.createShorthandFactory({ Component: AlertDismissAction, mappedProp: 'content' });
 ...
 */
exports.default = types_1.withSafeTypeForAs(AlertDismissAction);
