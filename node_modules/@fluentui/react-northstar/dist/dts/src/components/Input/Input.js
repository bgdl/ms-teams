...
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.renderComponent = function (_a) {
        ...
        return Box_1.default.create(wrapper, {
            defaultProps: function () { return (tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, accessibility.attributes.root), { className: classnames_1.default(Input.className, className), children: (React.createElement(React.Fragment, null,
                    React.createElement(react_component_ref_1.Ref, { innerRef: function (inputElement) {
                        ...
                        defaultProps: function () { return (tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, htmlInputProps), { as: 'input', disabled: disabled,
                            type: type,
                            value: value, className: Input.slotClassNames.input, styles: styles.input, onChange: _this.handleChange }), utils_1.applyAccessibilityKeyHandlers(accessibility.keyHandlers.input, htmlInputProps))); },
                    })),
