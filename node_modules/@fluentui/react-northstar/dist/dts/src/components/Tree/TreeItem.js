...
var TreeItem = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(TreeItem.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var classes = react_bindings_1.useStyles(TreeItem.displayName, {
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(TreeItem.handledProps, props);
    var element = (React.createElement(ElementType, tslib_1.__assign({}, getA11Props('root', tslib_1.__assign(tslib_1.__assign({ className: classes.root }, utils_1.rtlTextContainer.getAttributes({ forElements: [children] })), unhandledProps))), utils_1.childrenExist(children)
        ? children
        : TreeTitle_1.default.create(title, {
...
TreeItem.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    content: false,
...
TreeItem.create = utils_1.createShorthandFactory({
    Component: TreeItem,
    mappedProp: 'title',
});
/**
 ...
 */
exports.default = types_1.withSafeTypeForAs(TreeItem);
