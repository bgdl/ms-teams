...
var processInputValues = function (p) {
    ...
    if (isNaN(min))
        min = Number(Slider.defaultProps.min);
    if (isNaN(max))
        max = Number(Slider.defaultProps.max);
...
var Slider = function (props) {
    ...
    var _b = react_bindings_1.useTelemetry(Slider.displayName, context.telemetry), setStart = _b.setStart, setEnd = _b.setEnd;
    setStart();
    ...
    var _e = react_bindings_1.useStyles(Slider.displayName, {
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(Slider.handledProps, props);
    ...
    var inputElement = Box_1.default.create(input || type, {
        defaultProps: function () {
            return getA11Props('input', tslib_1.__assign(tslib_1.__assign({}, htmlInputProps), { as: 'input', className: Slider.slotClassNames.input, fluid: fluid, min: numericMin, max: numericMax, step: step, styles: resolvedStyles.input, type: type, value: numericValue, vertical: vertical }));
        },
    ...
    var element = (React.createElement(ElementType, tslib_1.__assign({}, getA11Props('root', tslib_1.__assign({ className: classes.root }, restProps))),
        React.createElement("div", tslib_1.__assign({}, getA11Props('inputWrapper', {
            className: classnames_1.default(Slider.slotClassNames.inputWrapper, classes.inputWrapper),
        })),
            React.createElement("span", tslib_1.__assign({}, getA11Props('rail', { className: classnames_1.default(Slider.slotClassNames.rail, classes.rail) }))),
            React.createElement("span", tslib_1.__assign({}, getA11Props('track', { className: classnames_1.default(Slider.slotClassNames.track, classes.track) }), { style: { width: valueAsPercentage } })),
            ...
            React.createElement("span", tslib_1.__assign({}, getA11Props('thumb', { className: classnames_1.default(Slider.slotClassNames.thumb, classes.thumb) }), { style: (_a = {}, _a[context.rtl ? 'right' : 'left'] = valueAsPercentage, _a) })))));
    setEnd();
    return element;
};
 ...
 */
exports.default = types_1.withSafeTypeForAs(Slider);
