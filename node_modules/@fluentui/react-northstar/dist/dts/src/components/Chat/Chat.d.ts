...
export declare type ChatStylesProps = {};
declare const _default: {
    ...
    (x: {
        ...
        items?: ShorthandCollection<ChatItemProps, never>;
        className?: string;
    ...
    displayName: string;
    className: string;
    handledProps: ("children" | "className" | "variables" | "styles" | "accessibility" | "design" | "items")[];
    create: import("../../utils").ShorthandFactory<ChatProps>;
    ...
    Item: {
        ...
        displayName: string;
        className: string;
        handledProps: ("children" | "className" | "variables" | "styles" | "accessibility" | "message" | "design" | "attached" | "contentPosition" | "gutter")[];
        create: import("../../utils").ShorthandFactory<ChatItemProps>;
    ...
    Message: {
        ...
        (x: {
            accessibility?: Accessibility<never>;
            actionMenu?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | (import("../..").MenuProps & {
                popper?: import("../..").PositioningProps;
            } & import("../../types").ObjectOf<any> & {
                children?: string | number | boolean | {} | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | import("../../types").ShorthandRenderProp<import("../..").MenuProps & {
                    popper?: import("../..").PositioningProps;
                }>;
            }) | ShorthandCollection<import("../..").MenuItemProps, never>;
            attached?: boolean | "bottom" | "top";
            ...
            reactionGroup?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | ShorthandCollection<import("../..").ReactionProps, never> | (import("../..").ReactionGroupProps & import("../../types").ObjectOf<any> & {
                children?: string | number | boolean | {} | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | import("../../types").ShorthandRenderProp<import("../..").ReactionGroupProps>;
            });
            reactionGroupPosition?: "end" | "start";
        ...
        displayName: string;
        className: string;
        handledProps: ("content" | "children" | "className" | "onFocus" | "onBlur" | "onMouseEnter" | "variables" | "styles" | "accessibility" | "design" | "timestamp" | "attached" | "badgePosition" | "mine" | "actionMenu" | "author" | "badge" | "positionActionMenu" | "reactionGroup" | "reactionGroupPosition" | "unstable_overflow")[];
        create: import("../../utils").ShorthandFactory<import("./ChatMessage").ChatMessageProps>;
