...
var MenuButton = /** @class */ (function (_super) {
    ...
    MenuButton.prototype.renderComponent = function (_a) {
        ...
        var content = Menu_1.default.create(menu, {
            defaultProps: function () { return (tslib_1.__assign(tslib_1.__assign({}, accessibility.attributes.menu), { vertical: true })); },
    ...
    MenuButton.className = 'ui-menubutton';
    MenuButton.slotClassNames = {
    ...
    MenuButton.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
        as: true,
        content: false,
    })), { align: PropTypes.oneOf(positioner_1.ALIGNMENTS), defaultOpen: PropTypes.bool, mountNode: customPropTypes.domNode, mouseLeaveDelay: PropTypes.number, offset: PropTypes.string, on: PropTypes.oneOfType([
