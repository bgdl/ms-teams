...
var Dialog = /** @class */ (function (_super) {
    ...
    Dialog.prototype.renderComponent = function (_a) {
        ...
        var cancelElement = Button_1.default.create(cancelButton, {
            overrideProps: this.handleCancelButtonOverrides,
        });
        var confirmElement = Button_1.default.create(confirmButton, {
        ...
        var dialogContent = (React.createElement(react_component_ref_1.Ref, { innerRef: this.contentRef },
            React.createElement(ElementType, tslib_1.__assign({ className: classes.root }, accessibility.attributes.popup, unhandledProps, utils_2.applyAccessibilityKeyHandlers(accessibility.keyHandlers.popup, unhandledProps)),
                Header_1.default.create(header, {
                    defaultProps: function () { return (tslib_1.__assign({ as: 'h2', className: Dialog.slotClassNames.header, styles: styles.header }, accessibility.attributes.header)); },
                }),
                Button_1.default.create(headerAction, {
                    defaultProps: function () { return (tslib_1.__assign({ className: Dialog.slotClassNames.headerAction, styles: styles.headerAction, text: true, iconOnly: true }, accessibility.attributes.headerAction)); },
                }),
                Box_1.default.create(content, {
                    defaultProps: function () { return (tslib_1.__assign({ styles: styles.content, className: Dialog.slotClassNames.content }, accessibility.attributes.content)); },
                }),
