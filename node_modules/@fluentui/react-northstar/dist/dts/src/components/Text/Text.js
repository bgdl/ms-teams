...
var Text = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(Text.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var classes = react_bindings_1.useStyles(Text.displayName, {
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(Text.handledProps, props);
...
Text.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({ color: true })), { atMention: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(['me'])]), disabled: PropTypes.bool, error: PropTypes.bool, important: PropTypes.bool, size: customPropTypes.size, weight: PropTypes.oneOf(['light', 'semilight', 'regular', 'semibold', 'bold']), success: PropTypes.bool, temporary: PropTypes.bool, align: customPropTypes.align, timestamp: PropTypes.bool, truncated: PropTypes.bool });
Text.handledProps = Object.keys(Text.propTypes);
Text.create = utils_1.createShorthandFactory({ Component: Text, mappedProp: 'content' });
/**
 * A Text consistently styles and formats occurrences of text.
 */
exports.default = types_1.withSafeTypeForAs(Text);
