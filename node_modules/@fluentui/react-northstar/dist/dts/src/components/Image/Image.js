...
var Image = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(Image.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var classes = react_bindings_1.useStyles(Image.displayName, {
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(Image.handledProps, props);
...
Image.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    children: false,
    content: false,
})), { avatar: PropTypes.bool, circular: PropTypes.bool, fluid: PropTypes.bool });
Image.handledProps = Object.keys(Image.propTypes);
Image.create = utils_1.createShorthandFactory({ Component: Image, mappedProp: 'src', allowsJSX: false });
/**
 ...
 */
exports.default = types_1.withSafeTypeForAs(Image);
