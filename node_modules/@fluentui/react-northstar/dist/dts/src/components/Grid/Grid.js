...
var Grid = /** @class */ (function (_super) {
    ...
    Grid.prototype.renderComponent = function (_a) {
        ...
        return (React.createElement(ElementType, tslib_1.__assign({ className: classes.root }, utils_1.rtlTextContainer.getAttributes({ forElements: [children, content] }), accessibility.attributes.root, unhandledProps), utils_1.childrenExist(children) ? children : content));
    };
    Grid.displayName = 'Grid';
    Grid.className = 'ui-grid';
    Grid.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
        content: false,
 ...
 */
exports.default = types_1.withSafeTypeForAs(Grid);
