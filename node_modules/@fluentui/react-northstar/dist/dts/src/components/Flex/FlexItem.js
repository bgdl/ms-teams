...
var FlexItem = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(FlexItem.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var _b = react_bindings_1.useStyles(FlexItem.displayName, {
...
FlexItem.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    children: false,
    accessibility: false,
    content: false,
