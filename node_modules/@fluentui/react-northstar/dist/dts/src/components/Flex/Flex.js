...
var Flex = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(Flex.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var classes = react_bindings_1.useStyles(Flex.displayName, {
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(Flex.handledProps, props);
...
Flex.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    accessibility: false,
    content: false,
 ...
 */
exports.default = types_1.withSafeTypeForAs(Flex);
