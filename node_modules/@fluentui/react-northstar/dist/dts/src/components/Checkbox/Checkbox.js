...
var Checkbox = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(Checkbox.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var _c = react_bindings_1.useStyles(Checkbox.displayName, {
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(Checkbox.handledProps, props);
...
Checkbox.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    content: false,
...
Checkbox.create = utils_1.createShorthandFactory({
    Component: Checkbox,
    mappedProp: 'label',
});
/**
 ...
 */
exports.default = types_1.withSafeTypeForAs(Checkbox);
