import { Accessibility, ToolbarMenuRadioGroupBehaviorProps } from '@fluentui/accessibility';
...
export declare type ToolbarMenuRadioGroupStylesProps = never;
...
declare const _default: {
    ...
    create: import("../../utils").ShorthandFactory<ToolbarMenuRadioGroupProps>;
