...
import { ContentComponentProps, ChildrenComponentProps, UIComponentProps } from '../../utils';
export interface BoxProps extends UIComponentProps<BoxProps>, ContentComponentProps, ChildrenComponentProps {
    /** Accessibility behavior if overridden by the user. */
    accessibility?: Accessibility<never>;
}
export declare type BoxStylesProps = never;
declare const _default: {
    ...
    create: import("../../utils").ShorthandFactory<BoxProps>;
};
/**
