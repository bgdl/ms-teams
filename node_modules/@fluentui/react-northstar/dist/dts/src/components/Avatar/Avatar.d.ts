...
declare const _default: {
    ...
    displayName: string;
    className: string;
    handledProps: ("size" | "icon" | "square" | "label" | "image" | "status" | "className" | "name" | "variables" | "styles" | "accessibility" | "design" | "getInitials")[];
    create: import("../../utils").ShorthandFactory<AvatarProps>;
};
/**
