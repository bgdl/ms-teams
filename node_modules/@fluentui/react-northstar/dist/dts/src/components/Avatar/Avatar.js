...
var Avatar = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(Avatar.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var _b = react_bindings_1.useStyles(Avatar.displayName, {
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(Avatar.handledProps, props);
    ...
    var labelElement = Label_1.default.create(label || {}, {
        defaultProps: function () {
    ...
    var result = (React.createElement(ElementType, tslib_1.__assign({}, getA11Props('root', tslib_1.__assign({ className: classes.root }, unhandledProps))),
        ...
        Status_1.default.create(status, {
            defaultProps: function () {
...
Avatar.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    children: false,
    content: false,
...
Avatar.create = utils_1.createShorthandFactory({ Component: Avatar, mappedProp: 'name' });
/**
 * An Avatar is a graphical representation of a user.
 */
exports.default = types_1.withSafeTypeForAs(Avatar);
