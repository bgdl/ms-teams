...
var RadioGroup = /** @class */ (function (_super) {
        ...
        _this.renderItems = function (vertical) {
            ...
            return _.map(items, function (item, index) {
                return RadioGroupItem_1.default.create(item, {
                    defaultProps: function () { return (tslib_1.__assign({ className: RadioGroup.slotClassNames.item, vertical: vertical }, (index === 0 && isNoneValueSelected && { tabIndex: 0 }))); },
    ...
    RadioGroup.className = 'ui-radiogroup';
