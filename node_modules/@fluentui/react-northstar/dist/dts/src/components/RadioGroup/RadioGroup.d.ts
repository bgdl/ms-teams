...
declare const _default: {
    ...
    (x: {
        ...
        checkedValue?: import("csstype").AnimationIterationCountProperty;
        onCheckedValueChange?: ComponentEventHandler<RadioGroupItemProps>;
        defaultCheckedValue?: import("csstype").AnimationIterationCountProperty;
        items?: ShorthandCollection<RadioGroupItemProps, never>;
        vertical?: boolean;
        className?: string;
    ...
    Item: {
        ...
        (x: {
            ...
            defaultChecked?: boolean;
            disabled?: boolean;
            indicator?: import("../../types").ShorthandValue<import("../..").BoxProps>;
            name?: string;
        ...
        _handledPropsCache: string[];
        slotClassNames: import("./RadioGroupItem").RadioGroupItemSlotClassNames;
    };
};
/**
