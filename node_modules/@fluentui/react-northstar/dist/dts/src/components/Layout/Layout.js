...
var Layout = /** @class */ (function (_super) {
    ...
    Layout.prototype.renderComponent = function (_a) {
        ...
        if (reducing && isSingleArea) {
            var composedClasses = classnames_1.default(classes.root, startArea && Layout.slotClassNames.reducedStart, mainArea && Layout.slotClassNames.reducedMain, endArea && Layout.slotClassNames.reducedEnd);
    ...
    Layout.defaultProps = {
        ...
        renderStartArea: function (_a) {
            ...
            return (start && (React.createElement("div", tslib_1.__assign({ className: classnames_1.default(Layout.slotClassNames.start, classes.start) }, utils_1.rtlTextContainer.getAttributes({ forElements: [start] })), start)));
        },
        renderMainArea: function (_a) {
            var main = _a.main, classes = _a.classes;
            return (main && (React.createElement("div", tslib_1.__assign({ className: classnames_1.default(Layout.slotClassNames.main, classes.main) }, utils_1.rtlTextContainer.getAttributes({ forElements: [main] })), main)));
        },
        renderEndArea: function (_a) {
            var end = _a.end, classes = _a.classes;
            return (end && (React.createElement("div", tslib_1.__assign({ className: classnames_1.default(Layout.slotClassNames.end, classes.end) }, utils_1.rtlTextContainer.getAttributes({ forElements: [end] })), end)));
        },
        // Heads up!
        // IE11 Doesn't support grid-gap, insert virtual columns instead
        renderGap: function (_a) {
            var gap = _a.gap, classes = _a.classes;
            return gap && React.createElement("span", { className: classnames_1.default(Layout.slotClassNames.gap, classes.gap) });
        },
    };
    return Layout;
}(utils_1.UIComponent));
