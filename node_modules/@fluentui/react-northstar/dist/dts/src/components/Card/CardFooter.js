...
var CardFooter = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(CardFooter.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(CardFooter.handledProps, props);
    var getA11yProps = react_bindings_1.useAccessibility(props.accessibility, {
        debugName: CardFooter.displayName,
        rtl: context.rtl,
    });
    var classes = react_bindings_1.useStyles(CardFooter.displayName, {
...
CardFooter.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon()), { fitted: PropTypes.bool });
CardFooter.handledProps = Object.keys(CardFooter.propTypes);
CardFooter.create = utils_1.createShorthandFactory({ Component: CardFooter });
/**
 * A CardFooter is used to display data in Card component footer
 */
exports.default = types_1.withSafeTypeForAs(CardFooter);
