...
var CardBody = function (props) {
    ...
    var _a = react_bindings_1.useTelemetry(CardBody.displayName, context.telemetry), setStart = _a.setStart, setEnd = _a.setEnd;
    setStart();
    ...
    var unhandledProps = react_bindings_1.useUnhandledProps(CardBody.handledProps, props);
    var getA11yProps = react_bindings_1.useAccessibility(props.accessibility, {
        debugName: CardBody.displayName,
        rtl: context.rtl,
    });
    var classes = react_bindings_1.useStyles(CardBody.displayName, {
...
CardBody.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon()), { fitted: PropTypes.bool });
CardBody.handledProps = Object.keys(CardBody.propTypes);
CardBody.create = utils_1.createShorthandFactory({ Component: CardBody });
/**
 * A CardBody is used to display data in Card body.
 */
exports.default = types_1.withSafeTypeForAs(CardBody);
