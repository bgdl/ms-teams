...
var layoutStyles = {
    root: function (_a) {
        ...
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, (debug && debugStyles_1.debugRoot())), (_b = { justifyItems: justifyItems,
                alignItems: alignItems, display: 'grid' }, _b[vertical ? 'gridTemplateRows' : 'gridTemplateColumns'] = [
            // Heads up!
    ...
    main: function (_a) {
        var _b;
        var p = _a.props;
        return (tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, (p.debug && debugStyles_1.debugArea())), (_b = { alignItems: 'center', display: 'grid' }, _b[p.vertical ? '-ms-grid-row' : '-ms-grid-column'] = countTrue([p.start, p.start && p.gap, p.main]), _b)), p.mainCSS));
    },
    end: function (_a) {
        var _b;
        var p = _a.props;
