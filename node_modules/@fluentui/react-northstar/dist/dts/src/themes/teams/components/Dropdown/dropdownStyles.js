...
var dropdownStyles = {
    ...
    clearIndicator: function (_a) {
        ...
        return ({
            ...
            backgroundImage: clearIndicatorUrl_1.default(v.color),
    ...
    container: function (_a) {
        ...
        return (tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ display: 'flex', flexWrap: 'wrap', position: 'relative', borderStyle: 'solid', borderColor: v.borderColor, outline: 0, width: getWidth(p, v), borderWidth: p.search ? "0 0 " + v.searchBorderBottomWidth + " 0" : v.borderWidth, color: v.color, backgroundColor: v.backgroundColor, borderRadius: v.containerBorderRadius }, (p.open && p.position === 'above' && { borderRadius: v.openAboveContainerBorderRadius })), (p.open && p.position === 'below' && { borderRadius: v.openBelowContainerBorderRadius })), { ':hover': tslib_1.__assign({ backgroundColor: v.backgroundColorHover, borderColor: v.borderColorHover }, (p.open && {
            ...
            !p.open &&
            p.isFromKeyboard &&
            getBorderFocusStyles_1.default({ variables: siteVariables })[':focus-visible'])))), (p.inline && tslib_1.__assign(tslib_1.__assign({}, transparentColorStyleObj), { alignItems: 'center' }))), (p.inverted && {
        ...
        })), (_b = {}, _b["& ." + Dropdown_1.default.slotClassNames.triggerButton] = tslib_1.__assign({}, (p.disabled && {
            color: siteVariables.colorScheme.default.foregroundDisabled,
        })), _b)));
    },
    selectedItems: function (_a) {
        var p = _a.props, v = _a.variables;
        return (tslib_1.__assign({ display: 'flex', flexWrap: 'wrap', overflowY: 'auto', maxHeight: v.selectedItemsMaxHeight, width: '100%' }, (p.toggleIndicator && { paddingRight: v.toggleIndicatorSize })));
    },
    triggerButton: function (_a) {
        var p = _a.props, v = _a.variables;
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ overflow: 'hidden', boxShadow: 'none' }, transparentColorStyleObj), { margin: '0', justifyContent: 'left', padding: v.comboboxPaddingButton }), (p.multiple && { minWidth: 0, flex: 1 })), transparentColorStyleObj), { ':focus': tslib_1.__assign({ color: v.color }, transparentColorStyleObj), ':focus-visible': tslib_1.__assign(tslib_1.__assign({ color: v.color }, transparentColorStyle), { ':after': {
                    borderColor: 'transparent',
                    borderRightWidth: 0,
                }, ':before': {
                    borderColor: 'transparent',
    ...
    toggleIndicator: function (_a) {
        var p = _a.props, v = _a.variables;
        return (tslib_1.__assign(tslib_1.__assign({ alignItems: 'center', display: 'flex', justifyContent: 'center', backgroundImage: toggleIndicatorUrl_1.default(p.disabled ? v.disabledColor : v.color), backgroundPosition: 'center', backgroundRepeat: 'no-repeat', cursor: 'pointer' }, (p.disabled && {
            cursor: 'default',
        })), { userSelect: 'none', margin: 0, position: 'absolute', right: utils_1.pxToRem(8), height: '100%', width: utils_1.pxToRem(12) }));
    },
};
