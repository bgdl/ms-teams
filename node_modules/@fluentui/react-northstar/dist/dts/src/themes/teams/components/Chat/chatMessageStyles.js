...
var initialStyles_1 = require("../../../../utils/positioner/initialStyles");
...
var chatMessageStyles = {
    root: function (_a) {
        ...
        })), getBorderFocusStyles_1.default({ variables: siteVariables })), (_.isNil(v.showActionMenu) && {
            ':hover': (_b = {},
                _b["> ." + ChatMessage_1.default.slotClassNames.actionMenu] = {
                    opacity: 1,
                    width: 'auto',
                    '[x-out-of-boundaries]': {
                        opacity: 0,
    ...
    actionMenu: function (_a) {
        ...
        return (tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ backgroundColor: v.backgroundColor, border: '1px solid', borderColor: v.reactionGroupBorderColor, borderRadius: v.borderRadius, boxShadow: v.actionMenuBoxShadow, 
            // we need higher zIndex for the action menu in order to be displayed above the focus border of the chat message
            zIndex: v.overlayZIndex }, initialStyles_1.default), (_.isNil(v.showActionMenu) && {
...
exports.default = chatMessageStyles;
