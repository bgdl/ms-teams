...
var dropdownItemStyles = {
    root: function (_a) {
        ...
        })), { position: 'relative' }), (p.active && tslib_1.__assign(tslib_1.__assign({}, (p.isFromKeyboard && getBorderFocusStyles_1.default({ variables: siteVariables, borderRadius: 0 })[':focus-visible'])), (!p.isFromKeyboard && tslib_1.__assign(tslib_1.__assign({ color: v.listItemColorHover, backgroundColor: v.listItemBackgroundColorHover }, (p.hasHeader && (_b = {},
            _b["& ." + DropdownItem_1.default.slotClassNames.header] = {
                color: v.listItemColorHover,
            },
            _b))), (p.hasContent && (_c = {},
            _c["& ." + DropdownItem_1.default.slotClassNames.content] = {
                color: v.listItemColorHover,
            },
            _c))))))));
    },
    ...
    checkableIndicator: function (_a) {
        var v = _a.variables;
        return ({
            backgroundImage: checkableIndicatorUrl_1.default(v.listItemSelectedColor),
...
exports.default = dropdownItemStyles;
