...
exports.default = {
    root: function (_a) {
        ...
        return tslib_1.__assign(tslib_1.__assign({ display: 'inline-block', verticalAlign: 'middle', position: 'relative', cursor: 'pointer', width: v.width, height: v.height || 'auto', outline: 0 }, borderFocusStyles[':focus']), { ':focus-visible': (_b = {},
                _b["& ." + Embed_1.default.slotClassNames.control] = tslib_1.__assign({ borderColor: v.focusBorderColor, opacity: 1 }, borderFocusStyles[':focus-visible']),
                _b), ':hover': (_c = {},
                _c["& ." + Embed_1.default.slotClassNames.control] = {
                    opacity: 1,
                    zIndex: v.zIndex,
                },
                _c) });
    ...
    control: function (_a) {
        ...
        return (tslib_1.__assign(tslib_1.__assign({ background: "0 no-repeat " + v.controlBackgroundColor, backgroundPositionX: utils_1.pxToRem(3), width: utils_1.pxToRem(48), height: utils_1.pxToRem(48), color: v.controlColor, padding: utils_1.pxToRem(4), borderRadius: '50%', backgroundImage: playIndicatorUrl_1.default(v.controlColor), backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }, (p.active && {
            backgroundImage: pauseIndicatorUrl_1.default(v.controlColor),
