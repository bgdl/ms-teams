...
var carouselNavigationItemStyles = {
    root: function (_a) {
        ...
        var active = p.active, iconOnly = p.iconOnly, primary = p.primary, vertical = p.vertical;
        ...
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ color: 'inherit', display: 'block', cursor: 'pointer', whiteSpace: 'nowrap' }, (iconOnly && {
            ...
            iconOnly && tslib_1.__assign({ color: v.iconOnlyColorActive }, getIconFillOrOutlineStyles_1.default({ outline: false })))), { 
            // focus styles
            ':focus-visible': tslib_1.__assign({}, (iconOnly && tslib_1.__assign({ borderRadius: '50%', borderColor: v.iconOnlyColorActive }, getIconFillOrOutlineStyles_1.default({ outline: false })))) }), (iconOnly &&
            primary && {
            color: 'inherit',
            ...
            // hover styles
            ':hover': tslib_1.__assign(tslib_1.__assign((_b = { color: 'inherit' }, _b["& ." + CarouselNavigationItem_1.default.slotClassNames.indicator] = {
                background: v.indicatorBackgroundColor,
            }, _b), (iconOnly && getIconFillOrOutlineStyles_1.default({ outline: false }))), (primary && iconOnly && { color: 'inherit' })) });
    },
    content: function (_a) {
        var p = _a.props;
        var widthAdjust = p.indicator ? 26 : 0;
        return tslib_1.__assign({ whiteSpace: 'normal', lineHeight: 1.5, marginTop: utils_1.pxToRem(-4), marginBottom: utils_1.pxToRem(-4), display: 'inline-block' }, (p.vertical && {
            width: 'max-content',
...
exports.default = carouselNavigationItemStyles;
