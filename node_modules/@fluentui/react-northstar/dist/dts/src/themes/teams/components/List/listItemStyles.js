...
var selectableHoverStyle = function (p, v) {
    ...
    return (_a = {
        ...
        _a["& ." + ListItem_1.default.slotClassNames.header] = { color: 'inherit' },
        _a["& ." + ListItem_1.default.slotClassNames.content] = { color: 'inherit' },
        // hide the header media and content media on hover
        _a["& ." + ListItem_1.default.slotClassNames.headerMedia] = tslib_1.__assign(tslib_1.__assign({}, accessibilityStyles_1.screenReaderContainerStyles), { color: 'inherit' }),
        _a["& ." + ListItem_1.default.slotClassNames.contentMedia] = { display: 'none', color: 'inherit' },
        // show the end media on hover
        _a["& ." + ListItem_1.default.slotClassNames.endMedia] = { display: 'block', color: 'inherit' },
        _a);
};
...
exports.default = listItemStyles;
