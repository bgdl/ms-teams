...
var _mergeProviderContexts = _interopRequireDefault(require("../../utils/mergeProviderContexts"));

var _ProviderConsumer = _interopRequireDefault(require("./ProviderConsumer"));

var _usePortalBox = _interopRequireWildcard(require("./usePortalBox"));
...
var Provider = function Provider(props) {
  ...
  var consumedContext = React.useContext(_reactFela.ThemeContext);
  var incomingContext = overwrite ? {} : consumedContext;
  var outgoingContext = (0, _mergeProviderContexts.default)(incomingContext, inputContext);
  var rtlProps = {}; // only add dir attribute for top level provider or when direction changes from parent to child

  if (!consumedContext || consumedContext.rtl !== outgoingContext.rtl && (0, _isBoolean2.default)(outgoingContext.rtl)) {
  ...
  var element = (0, _usePortalBox.default)({
  ...
  return React.createElement(_reactFela.RendererProvider, (0, _extends2.default)({
    ...
    overwrite: true
  }, React.createElement(_usePortalBox.PortalBoxContext.Provider, {
    value: element
...
Provider.Consumer = _ProviderConsumer.default;
