...
function (_AutoControlledCompon) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleDismissOverrides", function (predefinedProps) {
      return {
        onClick: function onClick(e, buttonProps) {
          ...
          (0, _invoke2.default)(_this.props, 'onVisibleChange', e, Object.assign({}, _this.props, {
            visible: false
          }));
  ...
  (0, _createClass2.default)(Alert, [{
    ...
    value: function renderComponent(config) {
      ...
      }), unhandledProps), (0, _utils.childrenExist)(children) ? children : this.renderContent(config));
    }
  }]);
  return Alert;
...
(0, _defineProperty2.default)(Alert, "propTypes", Object.assign({}, _utils.commonPropTypes.createCommon({
  content: 'shorthand'
}), {
...
(0, _defineProperty2.default)(Alert, "DismissAction", _AlertDismissAction.default);
