...
var _accessibility2 = require("@fluentui/accessibility");
...
function (_AutoControlledCompon) {
  ...
  function MenuButton() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleOpenChange", function (e, open, callback) {
  ...
  (0, _createClass2.default)(MenuButton, [{
    ...
    value: function renderComponent(_ref) {
      ...
      }, _accessibility.attributes.root, unhandledProps, (0, _utils.applyAccessibilityKeyHandlers)(_accessibility.keyHandlers.root, unhandledProps)), React.createElement(_reactComponentRef.Ref, {
    ...
    value: function getAutoControlledStateFromProps(props, state) {
      return {
        menuId: (0, _utils.getOrGenerateIdFromShorthand)('menubutton-menu-', props.menu, state.menuId),
        triggerId: (0, _utils.getOrGenerateIdFromShorthand)('menubutton-trigger-', props.trigger, state.triggerId)
      };
    }
  }]);
  return MenuButton;
...
(0, _defineProperty2.default)(MenuButton, "propTypes", Object.assign({}, _utils.commonPropTypes.createCommon({
  as: true,
  content: false
}), {
