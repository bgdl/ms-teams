...
var _isRightClick = _interopRequireDefault(require("../../utils/isRightClick"));
...
var Popup = function Popup(props) {
  ...
  var renderPopperChildren = function renderPopperChildren(_ref) {
    ...
    return React.createElement(_reactComponentNestingRegistry.Unstable_NestingAuto, null, function (getRefs, nestingRef) {
      return React.createElement(React.Fragment, null, React.createElement(_reactComponentRef.Ref, {
        ...
        type: "keydown",
        capture: true
      }), isOpenedByRightClick && React.createElement(React.Fragment, null, React.createElement(_reactComponentEventListener.EventListener, {
  ...
  var trySetOpen = function trySetOpen(newValue, event) {
    var isOpenedByRightClick = newValue && (0, _isRightClick.default)(event); // when new state 'open' === 'true', save the last focused element
  ...
  var updateContextPosition = function updateContextPosition(nativeEvent) {
    rightClickReferenceObject.current = nativeEvent ? (0, _createReferenceFromContextClick.default)(nativeEvent) : null;
  };
  ...
  var contentElement = open && React.createElement(_positioner.Popper, {
  ...
  var triggerElement = triggerNode && React.createElement(_reactComponentRef.Ref, {
    innerRef: triggerRef
  }, React.cloneElement(triggerNode, getA11yProps('trigger', triggerProps)));
  var element = React.createElement(React.Fragment, null, triggerElement, open && (inline ? contentElement : React.createElement(_PortalInner.default, {
    mountNode: mountNode
  }, contentElement)));
  setEnd();
  return element;
