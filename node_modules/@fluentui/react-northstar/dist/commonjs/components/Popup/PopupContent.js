...
var PopupContent = function PopupContent(props) {
  ...
  if (trapFocus) {
    ...
    element = React.createElement(_reactBindings.FocusTrapZone, focusTrapZoneProps, popupContent);
  } else if (autoFocus) {
    var autoFocusZoneProps = Object.assign({}, popupContentProps, {}, (0, _keys2.default)(autoFocus).length && autoFocus, {
      as: ElementType
    });
    element = React.createElement(_reactBindings.AutoFocusZone, autoFocusZoneProps, popupContent);
  } else {
