          ...
          return Object.assign({}, accessibility.attributes.root, {
            ...
            children: React.createElement(React.Fragment, null, React.createElement(_reactComponentRef.Ref, {
              ...
              defaultProps: function defaultProps() {
                ...
                }, (0, _utils.applyAccessibilityKeyHandlers)(accessibility.keyHandlers.input, htmlInputProps));
              }
            })), _Box.default.create(_this2.computeIcon(), {
              defaultProps: function defaultProps() {
                return {
...
(0, _defineProperty2.default)(Input, "propTypes", Object.assign({}, _utils.commonPropTypes.createCommon({
  content: false
}), {
...
Input.slotClassNames = {
  ...
  icon: "".concat(Input.className, "__icon")
};
/**
