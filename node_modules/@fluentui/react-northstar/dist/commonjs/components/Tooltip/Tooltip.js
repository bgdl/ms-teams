...
var Tooltip = function Tooltip(props) {
  ...
  var renderPopperChildren = function renderPopperChildren(popperProps) {
    var tooltipContent = _TooltipContent.default.create(content, {
    ...
    return tooltipContent ? React.createElement(_reactComponentRef.Ref, {
      innerRef: contentRef
    }, tooltipContent) : null;
  };
  ...
  var element = React.createElement(React.Fragment, null, triggerElement && React.createElement(_reactComponentRef.Ref, {
    innerRef: triggerRef
  }, React.cloneElement(triggerElement, getA11Props('trigger', triggerProps))), React.createElement(_PortalInner.default, {
    mountNode: mountNode
