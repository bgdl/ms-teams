  ...
  (0, _createClass2.default)(Toolbar, [{
    ...
    value: function hide(el) {
      ...
      if (this.context.target.activeElement === el || el.contains(this.context.target.activeElement)) {
        if (this.containerRef.current) {
          var firstFocusableItem = (0, _reactBindings.getFirstFocusable)(this.containerRef.current, this.containerRef.current.firstElementChild);
    ...
    value: function renderComponent(_ref2) {
      ...
      if (!overflow) {
        ...
        }, accessibility.attributes.root, unhandledProps), React.createElement(_toolbarVariablesContext.ToolbarVariablesProvider, {
          value: variables
        }, (0, _utils.childrenExist)(children) ? children : this.renderItems(items))));
      }
      ...
      return React.createElement(React.Fragment, null, React.createElement(_reactComponentRef.Ref, {
        ...
        value: variables
      }, (0, _utils.childrenExist)(children) ? children : this.renderItems(this.getVisibleItems()), this.renderOverflowItem(overflowItem))), React.createElement("div", {
...
(0, _defineProperty2.default)(Toolbar, "propTypes", Object.assign({}, _utils.commonPropTypes.createCommon(), {
