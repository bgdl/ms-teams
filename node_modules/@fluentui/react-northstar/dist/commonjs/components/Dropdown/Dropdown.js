...
function (_AutoControlledCompon) {
  ...
  function Dropdown() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "downshiftStateReducer", function (state, changes) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleStateChange", function (changes) {
      ...
      switch (type) {
        ...
        case _downshift.default.stateChangeTypes.clickItem:
          ...
          newState.searchQuery = _this.getSelectedItemAsString(changes.selectedItem);
          newState.value = multiple ? [].concat((0, _toConsumableArray2.default)(value), [changes.selectedItem]) : [changes.selectedItem];
          newState.open = false;
          newState.highlightedIndex = shouldAddHighlightedIndex ? items.indexOf(changes.selectedItem) : null;

          if (getA11ySelectionMessage && getA11ySelectionMessage.onAdd) {
            _this.setA11ySelectionMessage(getA11ySelectionMessage.onAdd(changes.selectedItem));
          }
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "setStateAndInvokeHandler", function (handlerNames, event, newState) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "clearA11ySelectionMessage", (0, _debounce2.default)(function () {
      _this.setState({
        a11ySelectionStatus: ''
      });
    }, Dropdown.a11yStatusCleanupTime));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "clearStartingString", (0, _debounce2.default)(function () {
      _this.setState({
        startingString: ''
      });
  ...
  (0, _createClass2.default)(Dropdown, [{
    ...
    value: function renderComponent(_ref2) {
      ...
      return React.createElement(ElementType, (0, _extends2.default)({
        ...
        }, multiple && _this2.renderSelectedItems(variables, rtl), search ? _this2.renderSearchInput(accessibilityRootPropsRest, rtl, highlightedIndex, getInputProps, selectItemAtIndex, toggleMenu, variables) : _this2.renderTriggerButton(styles, rtl, getToggleButtonProps)), showClearIndicator ? _Box.default.create(clearIndicator, {
        ...
        }) : _Box.default.create(toggleIndicator, {
          defaultProps: function defaultProps() {
            return {
    ...
    value: function renderItemsList(styles, variables, highlightedIndex, toggleMenu, selectItemAtIndex, getMenuProps, getItemProps, getInputProps, rtl) {
      ...
      }, (0, _positioner.getPopperPropsFromShorthand)(list)), _List.default.create(list, {
        defaultProps: function defaultProps() {
          return Object.assign({
    ...
    value: function renderItems(styles, variables, getItemProps, highlightedIndex) {
      ...
      return headerItem ? [headerItem].concat((0, _toConsumableArray2.default)(items)) : items;
    }
  }, {
    ...
    value: function renderItemsListHeader(styles) {
      ...
      if (headerMessage) {
        return {
          children: function children() {
            return _DropdownItem.default.create(headerMessage, {
              defaultProps: function defaultProps() {
                return {
    ...
    value: function renderItemsListFooter(styles) {
      ...
      if (loading) {
        return {
          children: function children() {
            return _DropdownItem.default.create(loadingMessage, {
              defaultProps: function defaultProps() {
                return {
                  key: 'loading-message',
      ...
      if (items && items.length === 0) {
        return {
          children: function children() {
            return _DropdownItem.default.create(noResultsMessage, {
              defaultProps: function defaultProps() {
                return {
...
(0, _defineProperty2.default)(Dropdown, "propTypes", Object.assign({}, _utils.commonPropTypes.createCommon({
  accessibility: false,
  children: false,
  content: false
}), {
