...
function (_UIComponent) {
  ...
  (0, _createClass2.default)(DropdownSelectedItem, [{
    ...
    value: function renderComponent(_ref) {
      ...
      var iconProps = (0, _isNil2.default)(icon) ? icon : {
        name: null,
        children: function children(ComponentType, props) {
          return _Box.default.create(icon, {
            defaultProps: function defaultProps() {
              return {
      ...
      var imageProps = (0, _isNil2.default)(image) ? image : {
        children: function children(ComponentType, props) {
...
(0, _defineProperty2.default)(DropdownSelectedItem, "propTypes", Object.assign({}, _utils.commonPropTypes.createCommon({
  accessibility: false,
  children: false
}), {
...
(0, _defineProperty2.default)(DropdownSelectedItem, "defaultProps", {
  // TODO: fix me
  icon: React.createElement(_reactIconsNorthstar.CloseIcon, null)
});
