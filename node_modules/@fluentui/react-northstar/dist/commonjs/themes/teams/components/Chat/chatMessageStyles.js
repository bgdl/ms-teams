...
var _initialStyles = _interopRequireDefault(require("../../../../utils/positioner/initialStyles"));
...
var chatMessageStyles = {
  ...
  actionMenu: function actionMenu(_ref5) {
    ...
    }, _initialStyles.default, {}, (0, _isNil2.default)(v.showActionMenu) && {
  ...
  badge: function badge(_ref9) {
    ...
    return _ref10 = {
      ...
      zIndex: v.zIndex
    }, (0, _defineProperty2.default)(_ref10, sidePosition, 0), (0, _defineProperty2.default)(_ref10, "transform", p.badgePosition === 'start' ? 'translateX(-50%)' : 'translateX(50%)'), (0, _defineProperty2.default)(_ref10, '& > :first-child', {
      display: 'inline-flex'
    }), _ref10;
  },
