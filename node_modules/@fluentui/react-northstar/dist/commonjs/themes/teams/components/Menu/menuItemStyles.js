...
var underlinedItem = function underlinedItem(color) {
  return {
    paddingBottom: 0,
    borderBottom: "solid ".concat((0, _utils.pxToRem)(4), " ").concat(color),
...
var menuItemStyles = {
  wrapper: function wrapper(_ref3) {
    ...
    return Object.assign({
      ...
      padding: "0 ".concat((0, _utils.pxToRem)(4)),
      margin: "0 ".concat((0, _utils.pxToRem)(4), " 0 0"),
      ':nth-child(n+2)': {
        marginLeft: "".concat((0, _utils.pxToRem)(4))
      },
      boxShadow: 'none'
      ...
      '::before': Object.assign({
        ...
        height: "calc(100% + ".concat((0, _utils.pxToRem)(4), ")"),
      ...
      }, (0, _defineProperty2.default)({}, "&>.".concat(_MenuItem.default.className, ">.").concat(_MenuItem.default.slotClassNames.indicator), Object.assign({
        backgroundImage: (0, _submenuIndicatorUrl.default)(v.indicatorColorHover, vertical)
      }, primary && {
        backgroundImage: (0, _submenuIndicatorUrl.default)(v.primaryIndicatorColorHover, vertical)
      })))
    }, iconOnly && {
      display: 'flex'
    }, {
  ...
  root: function root(_ref4) {
    ...
    return Object.assign({
      ...
      border: "".concat((0, _utils.pxToRem)(2), " solid transparent")
    }, {
      padding: v.horizontalPadding
    }, vertical && {
      padding: v.verticalItemPadding
    }, {}, pointing && vertical && {
      padding: "".concat((0, _utils.pxToRem)(8), " ").concat((0, _utils.pxToRem)(18))
    }, {}, underlined && {
      padding: "".concat((0, _utils.pxToRem)(4), " 0")
    }, {}, iconOnly && {
      margin: (0, _utils.pxToRem)(1),
      ...
      }, {}, !disabled && Object.assign({}, iconOnly && (0, _getIconFillOrOutlineStyles.default)({
        outline: false
      }), {}, primary ? Object.assign({}, iconOnly && {
        color: 'inherit'
  ...
  indicator: function indicator(_ref8) {
    ...
    return Object.assign({
      position: 'relative',
      float: 'right',
      left: (0, _utils.pxToRem)(12),
      userSelect: 'none',
      marginRight: (0, _utils.pxToRem)(4)
    }, p.inSubmenu && {
      position: 'absolute',
      top: (0, _utils.pxToRem)(6),
      right: (0, _utils.pxToRem)(2),
      left: 'unset'
    }, {}, rtl && {
      transform: "scaleX(-1)"
      ...
      backgroundImage: (0, _submenuIndicatorUrl.default)(v.indicatorColor, p.vertical)
    }, p.active && Object.assign({
      backgroundImage: (0, _submenuIndicatorUrl.default)(v.activeIndicatorColor, p.vertical)
    }, p.primary && Object.assign({
      backgroundImage: (0, _submenuIndicatorUrl.default)(v.activePrimaryIndicatorColor, p.vertical)
    }, p.vertical && {
      backgroundImage: (0, _submenuIndicatorUrl.default)(v.activePrimaryVerticalIndicatorColor, p.vertical)
    })), {}, p.underlined && {
      backgroundImage: (0, _submenuIndicatorUrl.default)(v.indicatorColor, p.vertical)
    }, {}, p.iconOnly && {
      backgroundImage: (0, _submenuIndicatorUrl.default)(v.indicatorColor, p.vertical)
