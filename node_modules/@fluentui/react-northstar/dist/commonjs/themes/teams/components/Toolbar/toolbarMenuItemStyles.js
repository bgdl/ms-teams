...
var _ToolbarMenuItem = _interopRequireDefault(require("../../../../components/Toolbar/ToolbarMenuItem"));
...
var toolbarMenuItemStyles = {
  root: function root(_ref) {
    ...
    return Object.assign({
      ...
      }, (0, _defineProperty2.default)(_hover, "& .".concat(_ToolbarMenuItem.default.slotClassNames.submenuIndicator), {
        backgroundImage: (0, _submenuIndicatorUrl.default)(v.menuItemForegroundHover || colors.menuItemForegroundHover)
      }), (0, _defineProperty2.default)(_hover, "& .".concat(_ToolbarMenuItem.default.slotClassNames.activeIndicator), {
    ...
    }, (0, _defineProperty2.default)(_ref2, "& .".concat(_ToolbarMenuItem.default.slotClassNames.submenuIndicator), {
      backgroundImage: (0, _submenuIndicatorUrl.default)(v.menuItemForegroundDisabled || colors.foregroundDisabled1)
    }), (0, _defineProperty2.default)(_ref2, "& .".concat(_ToolbarMenuItem.default.slotClassNames.activeIndicator), {
