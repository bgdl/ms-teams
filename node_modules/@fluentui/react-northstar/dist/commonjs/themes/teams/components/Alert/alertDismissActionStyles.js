...
var _AlertDismissAction = _interopRequireDefault(require("../../../../components/Alert/AlertDismissAction"));
...
var _dismissIndicatorUrl = _interopRequireDefault(require("./dismissIndicatorUrl"));
...
var getIndicatorStyles = function getIndicatorStyles(color, outline, size) {
  return {
    width: size,
    height: size,
    backgroundImage: (0, _dismissIndicatorUrl.default)(color, outline),
...
var alertDismissActionStyles = {
  root: function root(_ref) {
    ...
    return Object.assign({
      ...
      outline: true
    }), {}, !p.hasContent && (0, _defineProperty2.default)({}, "& .".concat(_AlertDismissAction.default.slotClassNames.content), Object.assign({}, getIndicatorStyles(dismissActionIndicatorColor, true, v.dismissActionIndicatorSize))), {
      ':hover': Object.assign({
        backgroundColor: v.hoverBackgroundColor,
        color: 'currentColor'
      }, (0, _getIconFillOrOutlineStyles.default)({
        outline: false
      }), {}, !p.hasContent && (0, _defineProperty2.default)({}, "& .".concat(_AlertDismissAction.default.slotClassNames.content), Object.assign({}, getIndicatorStyles(dismissActionIndicatorColor, false, v.dismissActionIndicatorSize))), {}, (0, _getBorderFocusStyles.default)({
        variables: {
      ...
      }, borderFocusStyles[':focus-visible'], {}, (0, _getIconFillOrOutlineStyles.default)({
        outline: false
      }), {}, !p.hasContent && (0, _defineProperty2.default)({}, "& .".concat(_AlertDismissAction.default.slotClassNames.content), Object.assign({}, getIndicatorStyles(dismissActionIndicatorColor, false, v.dismissActionIndicatorSize))), {
        ':hover': {
...
var _default = alertDismissActionStyles;
