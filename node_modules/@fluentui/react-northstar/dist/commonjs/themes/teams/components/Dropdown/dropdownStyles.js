...
var _toggleIndicatorUrl = _interopRequireDefault(require("./toggleIndicatorUrl"));
...
var dropdownStyles = {
  ...
  clearIndicator: function clearIndicator(_ref2) {
    ...
    return {
      ...
      backgroundImage: (0, _clearIndicatorUrl.default)(v.color),
  ...
  container: function container(_ref3) {
    ...
    }, (0, _defineProperty2.default)({}, "& .".concat(_Dropdown.default.slotClassNames.triggerButton), Object.assign({}, p.disabled && {
  ...
  toggleIndicator: function toggleIndicator(_ref10) {
    ...
    return Object.assign({
      ...
      display: 'flex',
      justifyContent: 'center',
      backgroundImage: (0, _toggleIndicatorUrl.default)(p.disabled ? v.disabledColor : v.color),
      backgroundPosition: 'center',
      backgroundRepeat: 'no-repeat',
      cursor: 'pointer'
    }, p.disabled && {
