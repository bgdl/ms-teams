...
var useAccessibility = function (behavior, options) {
    ...
    var definition = getAccessibility_1.default(debugName, behavior, mapPropsToBehavior(), rtl, actionHandlers);
    ...
    var getA11yProps = function (slotName, userProps) {
        ...
        var finalProps = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, definition.attributes[slotName]), userProps), { onKeyDown: slotHandlers.current[slotName] });
        return finalProps;
    };
    ...
    getA11yProps.unstable_wrapWithFocusZone = function (element) {
        if (definition.focusZone) {
            ...
            return React.createElement(FocusZone_1.default, tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, definition.focusZone.props), child.props), { as: child.type, isRtl: rtl }));
        }
        return element;
    };
    return getA11yProps;
