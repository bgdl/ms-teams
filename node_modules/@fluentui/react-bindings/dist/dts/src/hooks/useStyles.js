...
var useCurrentReactElement_1 = require("../compose/useCurrentReactElement");
...
var useStyles = function (displayName, options) {
    ...
    var elementProps = useCurrentReactElement_1.default().elementProps;
    var composeOptions = useComposeOptions_1.default();
    var _e = options.className, className = _e === void 0 ? process.env.NODE_ENV === 'production' ? '' : 'no-classname-🙉' : _e, _f = options.mapPropsToStyles, mapPropsToStyles = _f === void 0 ? function () { return ({}); } : _f, _g = options.mapPropsToInlineStyles, mapPropsToInlineStyles = _g === void 0 ? function () { return ({}); } : _g, _h = options.rtl, rtl = _h === void 0 ? false : _h;
    ...
    var composeProps = tslib_1.__assign(tslib_1.__assign({}, elementProps), componentStylesProps);
