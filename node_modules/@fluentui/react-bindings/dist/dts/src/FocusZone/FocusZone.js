...
var FocusZone = /** @class */ (function (_super) {
    ...
    function FocusZone(props) {
        ...
        _this._onFocus = function (ev) {
            ...
            if (shouldFocusInnerElementWhenReceivedFocus && ev.target === _this._root.current) {
                var maybeElementToFocus = defaultTabbableElement && defaultTabbableElement(_this._root.current);
        ...
        _this._onKeyDown = function (ev) {
            var _a = _this.props, direction = _a.direction, disabled = _a.disabled, shouldEnterInnerZone = _a.shouldEnterInnerZone;
            if (disabled) {
                return undefined;
            }
                ...
                switch (keyboardKey.getCode(ev)) {
                    ...
                    case keyboardKey.Tab:
                        if (_this.props.handleTabKey === accessibility_1.FocusZoneTabbableElements.all ||
                            ...
                            else if (direction === accessibility_1.FocusZoneDirection.horizontal || direction === accessibility_1.FocusZoneDirection.bidirectional) {
    ...
    FocusZone.prototype.render = function () {
        ...
        var ElementType = getElementType_1.default(this.props);
        var unhandledProps = getUnhandledProps_1.default(_.keys(FocusZone.propTypes), this.props);
     ...
     * TODO
     */
    FocusZone.prototype.tryInvokeClickForFocusable = function () {
        return false;
    };
    /**
