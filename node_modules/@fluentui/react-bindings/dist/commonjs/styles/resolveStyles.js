...
var resolveStyles = function resolveStyles(options, resolvedVariables, renderStylesInput) {
  ...
  var className = props.className,
      ...
      stylesProps = (0, _objectWithoutProperties2.default)(props, ["className", "design", "styles", "variables"]);
  ...
  if (displayNames.length === 1) {
    ...
    mergedStyles = _styles.mergeComponentStyles.apply(void 0, (0, _toConsumableArray2.default)(displayNames.map(function (displayName) {
      return theme.componentStyles[displayName];
    })));
  }

  if (!noInlineStylesOverrides) {
    mergedStyles = (0, _styles.mergeComponentStyles)(mergedStyles, props.design && (0, _styles.withDebugId)({
      root: props.design
    }, 'props.design'), props.styles && (0, _styles.withDebugId)({
      root: props.styles
    }, 'props.styles'));
  }
  ...
  Object.keys(mergedStyles).forEach(function (slotName) {
    ...
    Object.defineProperty(resolvedStyles, slotName, {
      ...
      set: function set(val) {
        ...
        if (cacheEnabled && theme) {
          stylesCache.set(theme, Object.assign({}, stylesCache.get(theme), (0, _defineProperty2.default)({}, slotCacheKey, val)));
        }
      ...
      get: function get() {
        ...
        if (cacheEnabled && theme) {
          stylesCache.set(theme, Object.assign({}, stylesCache.get(theme), (0, _defineProperty2.default)({}, slotCacheKey, resolvedStyles[lazyEvaluationKey])));
        }
    ...
    Object.defineProperty(classes, slotName, {
      ...
      set: function set(val) {
        if (cacheEnabled && theme) {
          classesCache.set(theme, Object.assign({}, classesCache.get(theme), (0, _defineProperty2.default)({}, slotCacheKey, val)));
        }
      ...
      get: function get() {
        ...
        if (renderStyles && styleObj) {
          ...
          if (cacheEnabled && theme) {
            classesCache.set(theme, Object.assign({}, classesCache.get(theme), (0, _defineProperty2.default)({}, slotCacheKey, classes[lazyEvaluationKey])));
          }
        }
